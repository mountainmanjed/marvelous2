...
loc_cE33360:
	...
	mov.l @(loc_cE333BC,pc),r12 ; r12 set to 0x8C03544C
	mov.b r3,@(r0,r14)
...
loc_cE35EBA:
	...
	mov r4,r5
	mov.l r4,@-r15
	mov.l @(loc_cE35F8C_to_loc_8c04CE3A,pc),r3 ; r3 set to 0x8C04CE3A
	mov.l @(r0,r4),r4
	jmp @r3
	add 0x04,r15
