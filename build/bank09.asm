...
loc_8C092432:
	mova @(loc_8C0924BC,pc),r0 ; r0init to 0x8C0924Bc
	mov.l @r15,r1
	fmov.s @r0,fr3
...
;----------------------------------------------
loc_8C09272C:
	mova @(loc_8C092870,pc),r0 ; r0init to 0x8C092870
	fmov.s @r0,fr3
...
loc_8C092B74:
	mova @(loc_8C092BFC,pc),r0 ; r0init to 0x8C092BFc
	fmov.s @r0,fr3
...
loc_8C09399E:
	mova @(loc_8C0939F0,pc),r0 ; r0init to 0x8C0939F0
	fmov.s @r0,fr3
...
loc_8C093DD6:
	mova @(loc_8C093EF8,pc),r0 ; r0init to 0x8C093EF8
	fmov.s @r0,fr3
...
loc_8C0941F4:
	mova @(loc_8C0942D4,pc),r0 ; r0init to 0x8C0942D4
	fmov.s @r0,fr3
...
loc_8C09462C:
	mova @(loc_8C094670,pc),r0 ; r0init to 0x8C094670
	fmov.s @r0,fr3
...
loc_8C094E5E:
	mova @(loc_8C094ED8,pc),r0 ; r0init to 0x8C094ED8
	fmov.s @r0,fr2
...
loc_8C0950D8:
	mova @(loc_8C095150,pc),r0 ; r0init to 0x8C095150
	fmov.s @r0,fr3
...
loc_8C097FB8:
	mova @(loc_8C098054,pc),r0 ; r0init to 0x8C098054
	fmov.s @r0,fr4
...
loc_8C097FF6:
	mova @(loc_8C09805C,pc),r0 ; r0init to 0x8C09805c
	fmov.s @r0,fr3
...
loc_8C098828:
	mova @(loc_8C0988C4,pc),r0 ; r0init to 0x8C0988C4
	fmov.s @r0,fr1
...
loc_8C098DD8:
	mova @(loc_8C098E30,pc),r0 ; r0init to 0x8C098E30
	fmov.s @r0,fr3
...
;----------------------------------------------
loc_8C09910C:
	mova @(loc_8C099238,pc),r0 ; r0init to 0x8C099238
	fmov.s @r0,fr3
...
loc_8C09A768:
	mova @(loc_8C09A80C,pc),r0 ; r0init to 0x8C09A80c
	fmov.s @r0,fr2
...
loc_8C09AC30:
	mova @(loc_8C09ACB0,pc),r0 ; r0init to 0x8C09ACB0
...
loc_8C09AD4A:
	...
	fadd fr3,fr4
	fcmp/gt fr4,fr2
	bt loc_8c09ae0a               ; loc_8c09adb8+0x52
	mov.b @(0x5,r14),r0
	mov.w @(0x1E,PC),r4
	add 0x01,r0
	mov.b r0,@(0x5,r14)
	...
	mov.b @(r0,r14),r3
	tst r3,r3
	bt.s loc_8c09adc0             ; loc_8c09adb8+0x8
	add r14,r4
	mov.l @(0x24,PC),r3
	bra loc_8c09adc4              ; loc_8c09adb8+0xc
	mov.l r3,@(0x14,r4)
...
loc_8C09B2AC:
	...
	extu.b r6,r3
	tst r3,r3
	bt loc_8c09b2f4               ; loc_8c09b2ec+0x8
	mov r14,r4
	bra loc_8c09b2e4
	mov r12,r5
...
loc_8C09FAC0:
mova @(loc_8C09FB9C,pc),r0 ; r0init to 0x8C09FB9c
fmov.s @r0,fr3
