...
;Air Dash counter check
	mov.w @(0xC2,PC),r0;1d5
	mov.b @(r0,r14),r2
	tst r2,r2
	bf loc_8c05422e

;??
	mov.w @(0xBC,PC),r0;1d0
	mov.b @(r0,r14),r0
	extu.b r0,r0
	cmp/eq 0x1A,r0
	bt loc_8c05422e
...
;Air dash height check
	...
	mov.l @(0xA4,PC),r1;8c151274
	extu.b r0,r0
	shll r0
	mov.w @(r0,r1),r3

	mova @(0xA0,PC),r0;8c054084
	fmov @r0,fr2;40092492 CpsYscale

	mova @(0xA0,PC),r0;8c052488
	lds r3,fpul
	fmov @r0,fr1;43800000

	mov.w @(0x86,PC),r0;0x41c
	float fpul,fr3
	fmov @(r0,r14),fr4
	mov 0x38,r0
	fmul fr2,fr3
...
loc_8c0541fe:
	mov.w @(0x74,PC),r5;300 button input
	mov 0x00,r7
	mov.l @(0x88,PC),r3;8c055cf6
	mov r15,r6
	jsr @r3
	mov r14,r4
	...
	mov.w @(0x64,PC),r0;14a
	mov.b @(r0,r14),r0
	extu.b r0,r0
	tst 0xE0,r0
	bt loc_8c054222

	mov.w @(0x54,PC),r0;201
	mov.b @(r0,r14),r2
	tst r2,r2
	bf loc_8c05422e

loc_8c054222:
	mov.l @(0x6C,PC),r2;8c0559da
	jsr @r2
	mov r14,r4
	extu.b r0,r0
	tst r0,r0
...
loc_8c0559da:
	mov.w @(0x9E,PC),r0;1f2
	mov.b @(r0,r4),r3
	tst r3,r3
	bf loc_8c055a6c

	mov.w @(0x98,PC),r0;1f3
	mov.b @(r0,r4),r3
	tst r3,r3
	bf loc_8c055a6c

	mov.w @(0x92,PC),r0;1d0
	mov.b @(r0,r4),r5
	extu.b r5,r0
	cmp/eq 0x12,r0
	bt.s loc_8c0559fe
...
loc_8c0559fe:
	mov.w @(0x80,PC),r0;1de
	mov.b @(r0,r4),r3
	tst r3,r3
	bf loc_8c055a6c

loc_8c055a06:
	mov.w @(0x7A,PC),r0;14a
	mov.b @(r0,r4),r0
	extu.b r0,r0
	tst 0x20,r0
	bf loc_8c055a6c
	...
	mov.w @(0x66,PC),r0;1d0
	mov.b @(r0,r4),r0
	extu.b r0,r0
	cmp/eq 0x15,r0
	bt loc_8c055a6c

	mov.w @(0x5C,PC),r0;1d0
	mov.b @(r0,r4),r0
	extu.b r0,r0
	cmp/eq 0x1C,r0
	bt loc_8c055a6c

	mov.w @(0x58,PC),r0;20c
	mov.l @(r0,r4),r2
	add 0x29,r0
	mov.b @(r0,r2),r3
	tst r3,r3
	...
	mov.w @(0x3E,PC),r0;1f9
	mov.b @(r0,r4),r0
	extu.b r0,r0
	cmp/eq 0x02,r0
	bf loc_8c055a5e

	mov.w @(0x44,PC),r0;41c
	fmov @(r0,r4),fr3
	mov 0x38,r0
	fmov @(r0,r4),fr2
	fcmp/gt fr3,fr2
...
loc_8c055a5e:
	mov.w @(0x1E,PC),r0;1d0
	mov.b @(r0,r4),r3
	mov.l @(0x30,PC),r0;8c14ebb0
	extu.b r3,r3
	mov.b @(r0,r3),r2
	tst r2,r2
	bt loc_8c055a70
...
loc_8c055cf6:
	mov.w @(0xA8,PC),r0;525
	mov.b @(r0,r4),r3
	tst r3,r3
	bt loc_8c055d14
	mov.w @(0xA2,PC),r0;45d
	mov.b @(r0,r4),r3
	tst r3,r3
	bt loc_8c055d28
	mov.w @(0x9C,PC),r0;448
	extu.b r7,r7
	mov.b @(r0,r4),r3
	cmp/eq r7,r3
	bt loc_8c055d24
...
loc_8c05cd0c:
	...
	mov.l @r5,r14
	extu.w r0,r0
	mov.l @(0xF0,PC),r1 ; loc_8c05ce08 to loc_8c1515e4
	mov.b @(r0,r14),r0
	extu.b r0,r0
	shll2 r0
	mov.l @(r0,r1),r0
