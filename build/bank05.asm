...
loc_8c051e16:
	mova @(loc_8c051ed4,PC),r0
	fmov @r0,fr3
	mov 0x5C,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c051ed8,PC),r0
	fmov @r0,fr3
	mov 0x60,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c051edc,PC),r0
	fmov @r0,fr3
...
loc_8c052eba:
	mova @(loc_8c052fb8,PC),r0
	fmov @r0,fr4
	mov.w @(loc_8c052fb0,PC),r0
	mov.w @(r0,r4),r3
	tst r3,r3
	bt loc_8c052eca
	mova @(loc_8c052fbc,PC),r0
	fmov @r0,fr4
...
loc_8c052eca:
	...
	fadd fr2,fr1
	fmov fr1,@(r0,r4)
	mova @(loc_8c052fc8,PC),r0
	fmov @r0,fr1
	mov 0x6C,r0
	fmov fr1,@(r0,r4)
	mova @(loc_8c052fcc,PC),r0
	fmov @r0,fr4
	mov 0x38,r0
	fmov @(r0,r4),fr3
	mov.w @(loc_8c052fb2,PC),r0
...
loc_8c05301e:
	mova @(loc_8c0530c0,PC),r0
	fmov @r0,fr4
	mov.w @(loc_8c0530b0,PC),r0
	mov.w @(r0,r4),r3
	tst r3,r3
	bt loc_8c05302e
	mova @(loc_8c0530c4,PC),r0
	fmov @r0,fr4
...
loc_8c05302e:
	...
	fadd fr2,fr1
	fmov fr1,@(r0,r4)
	mova @(loc_8c0530d0,PC),r0
	fmov @r0,fr1
	mov 0x6C,r0
	fmov fr1,@(r0,r4)
	mova @(loc_8c0530d4,PC),r0
	fmov @r0,fr4
	mov 0x38,r0
	fmov @(r0,r4),fr3
	mov.w @(loc_8c0530b4,PC),r0
...
loc_8c053a14:
	...
	tst r3,r3
	bf loc_8c053a46
	mova @(loc_8c053a90,PC),r0
	fmov @r0,fr3
	mov 0x6C,r0
	fmov @(r0,r14),fr2
	fcmp/gt fr3,fr2
	bf loc_8c053a46
	mova @(loc_8c053a94,PC),r0
	fmov @r0,fr3
	mov 0x6C,r0
	fmov fr3,@(r0,r14)
...
loc_8c053f8c:
	...
	shll r0
	mov.w @(r0,r1),r3
	mova @(loc_8c053ff0,PC),r0
	fmov @r0,fr2
	mova @(loc_8c053ff4,PC),r0
	lds r3,fpul
	fmov @r0,fr1
...
loc_8c056d1e:
	mova @(loc_8c056da8,PC),r0
	fmov @r0,fr3
	mov 0x60,r0
	fmov @(r0,r14),fr2
	fcmp/gt fr2,fr3
	bf loc_8c056d32
	mova @(loc_8c056dac,PC),r0
	fmov @r0,fr2
	mov 0x60,r0
	fmov fr2,@(r0,r14)
...
loc_8c057f38:
	...
	mov 0x50,r3
	fmov fr3,@(r0,r14)
	mova @(loc_8c057fa0,PC),r0
	fmov @r0,fr3
	mov.w @(loc_8c057f84,PC),r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c057fa4,PC),r0
	fmov @r0,fr3
	mov 0x6C,r0
	fmov fr3,@(r0,r14)
...
loc_8c0589c0:
	...
	shll r2
	mov.w @(r0,r2),r3
	mova @(loc_8c058a54,PC),r0
	fmov @r0,fr2
	mova @(loc_8c058a58,PC),r0
	lds r3,fpul
	fmov @r0,fr1
...
loc_8c05a92e:
	mova @(loc_8c05a96c,PC),r0
	fmov @r0,fr2
	mova @(loc_8c05a970,PC),r0
	fmov @r0,fr1
	mova @(loc_8c05a974,PC),r0
	fmul fr2,fr3
	fmov fr3,fr4
	fdiv fr1,fr4
	fmov @r0,fr3
...
loc_8c05b34c:
	...
	mov.l @(0x4,r15),r4
	fmul fr0,fr13
	mova @(loc_8c05b438,PC),r0
	fmov @r0,fr3
	mova @(loc_8c05b43c,PC),r0
	fmov @r0,fr2
	mov 0x60,r0
	add 0x10,r14
...
loc_8c05be7e:
	...
	#align4
loc_8c05be80:
	#data cpuscripting.loc_8c05fe88
loc_8c05be84:
	#data loc_8c05ff52
loc_8c05be88:
	#data cpuscripting.loc_8c05cd0c
loc_8c05be8c:
	#data cpuscripting.loc_8c05cd22
...
;==============================================
#module "build/cpu/cpuscripting.asm"
...
loc_8c06001c:
	#data cpuscripting.loc_8c05eca8
loc_8c060020:
	#data cpuscripting.loc_8c05ecc6
loc_8c060024:
	#data cpuscripting.loc_8c05ef36
loc_8c060028:
	#data cpuscripting.loc_8c05ef8a
loc_8c06002c:
	#data work.GameGlobalPointer
