...
loc_8c080528:
	mov.l @(bank08.loc_8c080578,pc),r3
	jsr @r3
	mov r14,r4
	mov.l @(bank08.loc_8c08057c,pc),r2
	jsr @r2
	mov r14,r4
...
loc_8c080b84:
	...
	fmov.s @r0,fr13
	mov 0x48,r0
	mov.l @(bank08.loc_8c080c50,pc),r3
	jsr @r3
	mov.l @(r0,r14),r4
	mov.l @(bank08.loc_8c080c54,pc),r3
	mov 0x48,r0
	fmov fr0,fr12
	jsr @r3
	mov.l @(r0,r14),r4
...
loc_8c080bec:
	mov 0x34,r0
	mov.l @(bank08.loc_8c080c58,pc),r4
	fmov.s @(r0,r14),fr3
	fadd fr15,fr3
	fmov.s fr3,@(r0,r14) 
	mov 0x38,r0
...
loc_8c080f04:
	...
	mov.l r4,@r15
	mov.b @(r0,r13),r3
	mov.l @(bank08.loc_8c080fa0,pc),r0
	extu.b r3,r3
	mov.l @(0x14,r13),r14
	shll r3
	mov.w @(r0,r3),r3
	...
	mov 0x48,r0
	lds r3,fpul 
	mov.l @(bank08.loc_8c080fa8,pc),r3
	float fpul,fr14
	jsr @r3
	mov.l @(r0,r14),r4
	mov.l @(bank08.loc_8c080fac,pc),r3
	mov 0x48,r0
	fmov fr0,fr12
	jsr @r3
	mov.l @(r0,r14),r4
...
loc_8c0815be:
mov.w @(bank08.loc_8c0816c4,pc),r0
mov.l @(0x14,r4),r1
mov.b @(r0,r1),r2
tst r2,r2
bt loc_8c0815e8
...
bf loc_8c0815e8
mov.b @(0x05,r4),r0 
mov.w @(bank08.loc_8c0816c8,pc),r3
add 0x01,r0
mov.b r0,@(0x05,r4) 
mov 0x00,r0
mov.b r0,@(0x06,r4) 
add r4,r3
mov.w @(bank08.loc_8c0816c8,pc),r0
mov.l @(0x14,r4),r2
mov.l @(r0,r2),r0
mov.l r0,@r3
...
#align4
loc_8c0817a0:
mov.l @(bank08.loc_8c0817f8,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank08.loc_8c0817da,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c081a3e:
lds.l @r15+,pr 
mov.l @(bank08.loc_8c081a6c,pc),r3
mov 0x17,r5
mov r14,r4
jmp @r3
mov.l @r15+,r14
...
tst r10,r3
bf loc_8c081c90
mov.l @(bank08.loc_8c081ccc,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bt loc_8c081d78
...
mov.b @(0x05,r14),r0 
mov 0x30,r5
mov.l @(bank08.loc_8c081e24,pc),r3
add 0x01,r0
mov.b r0,@(0x05,r14) 
mov 0x00,r0
mov.b r0,@(0x06,r14) 
...
mov.l @r15,r3
mov.b r2,@(r0,r3) 
mov.l @(bank08.loc_8c081e30,pc),r3
jsr @r3
mov r14,r4
mov 0x34,r0
fmov.s @(r0,r14),fr2
...
fsub fr3,fr2
fmov.s fr2,@(r0,r14) 
mov.w @(bank08.loc_8c081e20,pc),r0
mov.l @(r0,r14),r0
mov.b @(0x01,r0),r0 
extu.b r0,r0
cmp/eq 0x3A,r0 
...
loc_8c081d90:
mov.l @(bank08.loc_8c081e34,pc),r2
jsr @r2
mov r14,r4
...
loc_8c082398:
mov.l @(bank08.loc_8c0824b8,pc),r3
jsr @r3
mov r14,r4
...
loc_8c082416:
mov.l @(bank08.loc_8c0824c0,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bf loc_8c082426
...
tst r3,r3
bt loc_8c0824d4
mov.l @(bank08.loc_8c0824c4,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bt loc_8c082494
...
mov r12,r0
nop 
mov.l @(bank08.loc_8c0824c8,pc),r3
mov 0x0F,r5
mov.b r0,@(0x06,r14) 
mov 0x02,r6
jsr @r3
...
mov.l @(bank08.loc_8c0824cc,pc),r3
mov.l @(r0,r14),r13
mov r13,r5
jsr @r3
mov r14,r4
lds.l @r15+,pr 
mov r13,r5
mov.l @(bank08.loc_8c0824d0,pc),r2
mov r14,r4
mov.l @r15+,r11
mov.l @r15+,r12
mov.l @r15+,r13
...
loc_8c0824d4:
mov 0x5C,r1
mov.l @(bank08.loc_8c0825f8,pc),r3
add r14,r1
mov 0x34,r0
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
...
mov r14,r4
lds.l @r15+,pr 
mov.l @(bank08.loc_8c0825fc,pc),r2
mov r14,r4
mov.l @r15+,r11
mov.l @r15+,r12
mov.l @r15+,r13
...
mov.b r0,@(0x04,r5) 
mov 0x10,r0
mov.l @(bank08.loc_8c0829c0,pc),r3
mov 0x17,r5
mov.w r0,@(0x1C,r14) 
mov 0x00,r6
jsr @r3
...
loc_8c0829fe:
mov.l @(bank08.loc_8c082b24,pc),r3
jmp @r3
lds.l @r15+,pr 
#data 0x7F04
#data 0x4F26
...
exts.b r0,r0
cmp/pz r0
bt bank08.loc_8c083300
bsr bank08.loc_8c08348c
mov r14,r4
...
bt/s loc_8c08398c
mov 0x00,r6
mov.w @(bank08.loc_8c08394e,pc),r0
mov.b r6,@(r0,r4) 
add 0x01,r0
mov.b r6,@(r0,r4) 
add 0x06,r0
...
tst r3,r3
bf loc_8c083e18
mov.l @(bank08.loc_8c083ecc,pc),r3
jsr @r3
mov r14,r4
...
nop 
lds.l @r15+,pr 
mov.l @(bank08.loc_8c083ed0,pc),r2
mov r14,r4
mov.l @r15+,r8
mov.l @r15+,r12
mov.l @r15+,r13
...
mov.l @(bank08.loc_8c083ed4,pc),r11
tst r3,r3
add r14,r13
bt/s loc_8c083e70
fmov.s @r0,fr14
...
loc_8c083e8c:
mov.l @(bank08.loc_8c083edc,pc),r12
mov 0x00,r0
jsr @r12
mov.w r0,@(0x1E,r14) 
mov r0,r1
mov.l @(bank08.loc_8c083ee0,pc),r3
...
fmov.s fr4,@(r0,r13) 
mov r0,r1
mov.l @(bank08.loc_8c083fdc,pc),r3
...
jsr @r12
fmov.s fr5,@(r0,r13) 
mov.l @(bank08.loc_8c084134,pc),r3
mov r0,r1
jsr @r3
mov 0x32,r0
mov r0,r4
...
fmov.s @(r0,r14),fr3
mov 0x68,r0
mov.l @(bank08.loc_8c084140,pc),r3
fmul fr3,fr2
fmov.s @(r0,r14),fr3
mov 0x08,r0
fmul fr3,fr2
...
add 0x5C,r1
mov r5,r2
mov.l @(bank08.loc_8c084278,pc),r3
add r5,r4
add 0x5C,r2
jsr @r3
mov 0x0C,r0
...
bt/s loc_8c0841b4
fsub fr3,fr15
mov.l @(bank08.loc_8c08427c,pc),r3
mov 0x48,r0
jsr @r3
mov.l @(r0,r12),r4
...
fmov.s @r13,fr3
mov 0x04,r0
mov.l @(bank08.loc_8c084284,pc),r3
fmul fr15,fr3
fmov fr15,fr0
fmul fr15,fr3
fmov.s fr3,@(r0,r15) 
...
tst r3,r3
bt loc_8c085618
bsr bank08.loc_8c085a7e
mov r14,r4

loc_8c085618:
mov.l @(bank08.loc_8c08568c,pc),r2
jsr @r2
mov r14,r4

loc_8c08561e:
bsr bank08.loc_8c0851b4
mov r14,r4
tst r0,r0
bf/s loc_8c085630
mov r14,r4
...
loc_8c0859c0:
mov.l @(bank08.loc_8c085abc,pc),r3
mov 0x48,r0
mov.l @(0x14,r14),r4
jsr @r3
mov.l @(r0,r4),r4
...
mov r4,r13
sts.l pr,@-r15
mov.l @(bank08.loc_8c0874fc,pc),r8
mov 0x01,r10
mov.w @(loc_8C0874E4,pc),r9

loc_8c087436:
mov.l @(bank08.loc_8c0874f4,pc),r3
mov 0x01,r5
mov 0x02,r6
jsr @r3
mov r12,r4
...
loc_8c0878a4:
bsr bank08.loc_8c08759e
mov r14,r4
lds.l @r15+,pr 
mov r14,r4
bra bank08.loc_8c0875ca
mov.l @r15+,r14
...
loc_8c08a33e:
lds.l @r15+,pr 
mov.l @(bank08.loc_8c08a3a4,pc),r3
mov r14,r4
mov.l @r15+,r13
jmp @r3
mov.l @r15+,r14
...
extu.b r6,r11
mov.l @(bank08.loc_8c08a63c,pc),r10
cmp/pl r11
mov r4,r12
mov.b r5,@r15
bf/s loc_8c08a5e8
...
loc_8c08adc8:
bra bank08.loc_8c08b7dc
nop 

loc_8c08adcc:
mov.l @(bank08.loc_8c08ae08,pc),r3
jmp @r3
nop 
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank08.loc_8c08bae0,pc),r2
jmp @r2
mov.l @r15+,r14

loc_8c08ba82:
mov 0x5C,r1
mov.l @(bank08.loc_8c08baf0,pc),r3
add r14,r1
mov 0x34,r0
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
...
loc_8c08c540:
mov.l @(bank08.loc_8c08c674,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf loc_8c08c55a
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank08.loc_8c08c67c,pc),r2
jmp @r2
mov.l @r15+,r14
