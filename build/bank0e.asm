...
loc_8c0e0d96:
mov.b @(0x05,r14),r0 
mov.l @(bank0e.loc_8c0e0e08,pc),r13
tst r0,r0
bf loc_8c0e0e10
mov 0x34,r0
fmov.s @(r0,r5),fr3
...
exts.w r0,r0
cmp/pl r0
bt bank0e.loc_8c0e0ea0
mov.b @(0x05,r14),r0 
mov r14,r4
mov.l @(bank0e.loc_8c0e0f48,pc),r3
mov 0x1A,r6
add 0x01,r0
mov.b r0,@(0x05,r14) 
...
fmov.s @(r0,r13),fr3
mov 0x17,r5
mov.l @(bank0e.loc_8c0e1044,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r13),fr3
fmov.s fr3,@(r0,r14) 
...
loc_8c0e1018:
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0e1048,pc),r2
mov r14,r4
mov.l @r15+,r13
jmp @r2
mov.l @r15+,r14
...
loc_8c0e1024:
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0e104c,pc),r2
mov r14,r4
mov.l @r15+,r13
jmp @r2
mov.l @r15+,r14
...
loc_8c0e13a0:
mov.l @(bank0e.loc_8c0e1454,pc),r3
mov 0x17,r5
jmp @r3
lds.l @r15+,pr 
...
#align4
loc_8c0e18d4:
mov.l @(bank0e.loc_8c0e194c,pc),r3
jsr @r3
mov r14,r4
mov r14,r3
mov 0x38,r0
...
mov.b @(r0,r14),r0
mov 0x1F,r4
mov.l @(bank0e.loc_8c0e1954,pc),r3
extu.b r0,r0
neg r0,r0
add 0x28,r0
and r0,r4
...
tst r3,r3
bf loc_8c0e1df4
mov.l @(bank0e.loc_8c0e1e60,pc),r3
jsr @r3
mov r14,r4
...
#align4
loc_8c0e21c8:
mov.l @(bank0e.loc_8c0e22c8,pc),r3
jsr @r3
mov r14,r4
...
tst r3,r3
bt loc_8c0e21e0
mov.w @(bank0e.loc_8c0e22b2,pc),r3
mov.l @(0x18,r14),r0
add r3,r0
mov.b @(0x01,r0),r0 
mov.w r0,@(0x1C,r14) 
...
loc_8c0e24e4:
mov.l @(bank0e.loc_8c0e2528,pc),r2
mov 0x17,r5
exts.b r13,r6
jsr @r2
mov r14,r4
...
mov.l @(0x18,r4),r3
mov 0x34,r0
mov.l @(bank0e.loc_8c0e2630,pc),r5
fmov.s @(r0,r3),fr3
fmov.s fr3,@(r0,r4) 
mov 0x38,r0
mov.l @(0x18,r4),r3
...
mov.b @(r0,r13),r3
mov.b r3,@(r0,r14) 
mov.l @(bank0e.loc_8c0e2994,pc),r3
jsr @r3
mov r14,r4
mov.b @(0x05,r13),r0 
extu.b r0,r0
...
nop 
mov.b r0,@(0x05,r14) 
mov.w @(bank0e.loc_8c0e298e,pc),r0
mov.b r4,@(r0,r14) 
...
mov.b @(r0,r13),r1
mov r14,r5
mov.l @(bank0e.loc_8c0e2998,pc),r3
add 0x34,r5
tst r1,r1
mov 0x08,r7
mov 0x01,r6
...
mov r13,r4
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0e299c,pc),r2
mov 0x49,r5
mov r14,r4
fmov.s @r15+,fr12
mov.l @r15+,r8
...
loc_8c0e28c2:
mov r13,r2
mov.l @(bank0e.loc_8c0e29a0,pc),r3
mov r14,r1
add 0x34,r2
add 0x34,r1
jsr @r3
...
extu.b r3,r3
lds r3,fpul 
mov.l @(bank0e.loc_8c0e29a8,pc),r3
float fpul,fr3
fmul fr2,fr3
fdiv fr4,fr3
fmov.s fr3,@(r0,r14) 
...
jsr @r3
fmov.s fr3,@(r0,r14) 
mov.l @(bank0e.loc_8c0e29ac,pc),r2
mov r0,r13
shll8 r13
jsr @r2
mov r13,r4
mov.l @(bank0e.loc_8c0e29b0,pc),r3
fmov fr0,fr12
jsr @r3
mov r13,r4
mov 0x6C,r0
...
mov r13,r4
mov 0x6C,r0
mov.l @(bank0e.loc_8c0e29ac,pc),r3
fmov.s @(r0,r14),fr3
fmul fr0,fr3
fneg fr3
fmov fr3,fr12
...
tst r2,r2
bt loc_8c0e3186
mov.w @(bank0e.loc_8c0e31f0,pc),r0
mov 0x01,r3
mov.w @(r0,r14),r2
xor r3,r2
mov.w r2,@(r0,r14) 
...
loc_8c0e3212:
mov.l @(bank0e.loc_8c0e3250,pc),r3
jsr @r3
nop 
exts.b r0,r0
cmp/pz r0
bt bank0e.loc_8c0e3232
mov 0x20,r0
mov.b @(r0,r14),r3
tst r3,r3
bf bank0e.loc_8c0e3232
...
loc_8c0e339c:
mov.w @(bank0e.loc_8c0e342c,pc),r0
mov 0x01,r3
mov.b r3,@(r0,r13) 
...
mov.w @(loc_8C0E3432,pc),r0
extu.w r1,r1
mov.l @(bank0e.loc_8c0e3440,pc),r3
mov.l r1,@(r0,r13) 
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0e343c,pc),r0
mov.l @r15+,r12
mov.b @(r0,r6),r6
mov.l @r15+,r13
jmp @r3
...
loc_8c0e33ec:
mov.l @(bank0e.loc_8c0e3444,pc),r2
jsr @r2
mov r13,r4
exts.b r0,r0
cmp/pz r0
...
loc_8c0e3584:
mov.w @(bank0e.loc_8c0e3674,pc),r0
mov.b r4,@(r0,r14) 
mov.b @(r0,r5),r3
tst r3,r3
bt loc_8c0e3656
mov r5,r2
mov.l @(bank0e.loc_8c0e367c,pc),r3
mov r14,r1
add 0x34,r2
add 0x34,r1
jsr @r3
...
loc_8c0e35e2:
mov.l @(bank0e.loc_8c0e3680,pc),r3
mov 0x1B,r5
mov.w @r15,r6
jsr @r3
mov r14,r4
...
tst r3,r0
bf loc_8c0e3612
mov.l @(bank0e.loc_8c0e3688,pc),r3
jsr @r3
mov r14,r4
...
mov.l @(bank0e.loc_8c0e3850,pc),r3
mov.b @(r0,r5),r7
shll2 r7
add r3,r7
mov.w @(0x02,r7),r0 
...
mov.b @(0x04,r14),r0 
mov r13,r2
mov.l @(bank0e.loc_8c0e3bac,pc),r3
mov r14,r1
add 0x01,r0
add 0x34,r2
mov.b r0,@(0x04,r14) 
...
mov.l @(bank0e.loc_8c0e3bb0,pc),r3
add r14,r1
...
mov 0x0C,r0
mov 0x24,r0
mov.l @(bank0e.loc_8c0e3bb4,pc),r3
mov.b @(r0,r13),r2
mov 0x17,r5
mov 0x0B,r6
mov.b r2,@(r0,r14) 
...
mov.b @(r0,r13),r2
tst r2,r2
bf bank0e.loc_8c0e3b8a
mov.l @(bank0e.loc_8c0e3bb8,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt bank0e.loc_8c0e3b8a
...
#align4
loc_8c0e3de0:
mov.l @(bank0e.loc_8c0e3f28,pc),r10
mov 0x03,r5
mov 0x01,r6
jsr @r10
mov 0x00,r4
...
mov r0,r14
mov 0x26,r0
mov.l @(bank0e.loc_8c0e3f2c,pc),r2
mov.w r13,@(r0,r14) 
mov 0x00,r9
mov 0x21,r0
mov r9,r11
...
mov.b r9,@(r0,r4) 
add 0x01,r11
mov.l @(bank0e.loc_8c0e3f30,pc),r3
mov 0x21,r0
cmp/ge r12,r11
mov.b r8,@(r0,r4) 
mov.l r14,@(0x14,r4) 
...
add 0x18,r0
mov.l @(r0,r5),r2
mov.l @(bank0e.loc_8c0e4018,pc),r3
mov.l r2,@(r0,r4) 
mov r5,r2
add 0x34,r2
jsr @r3
...
#align4
loc_8c0e45ac:
mov.l @(bank0e.loc_8c0e45d8,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
loc_8c0e4738:
mov 0x34,r0
mov.l @(bank0e.loc_8c0e47c0,pc),r3
fmov.s @(r0,r13),fr3
mov 0x1D,r6
mov r14,r4
mov 0x17,r5
...
loc_8c0e48c4:
mov.l @(bank0e.loc_8c0e4970,pc),r3
jsr @r3
mov r14,r4
...
bt loc_8c0e494a
mov 0x5C,r1
mov.l @(bank0e.loc_8c0e4974,pc),r3
add r14,r1
mov 0x34,r0
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
...
mov.b @(r0,r13),r0
mov.l @(bank0e.loc_8c0e4f90,pc),r1
mov.w r0,@(0x1E,r14) 
mov 0x21,r0
mov.b @(r0,r14),r12
mov.w @(0x1E,r14),r0 
...
add r1,r12
add r0,r12
mov.w @(bank0e.loc_8c0e4f78,pc),r0
mov.b @r12,r2
tst r2,r2
bt/s loc_8c0e4f6a
mov.b r2,@(r0,r14) 
mov.w @(0x02,r12),r0 
mov 0x1B,r5
mov.l @(bank0e.loc_8c0e4f94,pc),r3
mov 0x12,r6
extu.w r0,r7
jsr @r3
mov r14,r4
...
fmov.s fr3,@(r0,r14) 
mov 0x50,r0
mov.l @(bank0e.loc_8c0e4f98,pc),r3
mov r14,r4
fmov.s fr3,@(r0,r14) 
lds.l @r15+,pr 
mov.l @r15+,r12
...
mov.b r0,@(0x04,r14) 
mov 0x01,r2
mov.w @(bank0e.loc_8c0e57fe,pc),r0
mov.b r13,@(r0,r14) 
mov.l @r15,r3
mov.b r2,@r3
...
mov.l @(bank0e.loc_8c0e5944,pc),r3
mov.l @(r0,r5),r6
mov.b @(0x01,r6),r0 
extu.b r0,r0
shll r0
...
loc_8c0e6386:
mov.l @(bank0e.loc_8c0e6404,pc),r3
mov 0x12,r5
fmov.s fr3,@(r0,r14) 
mov 0x0A,r6
jsr @r3
...
mov.l r3,@r15
mov.b @(r0,r5),r2
mov.l @(bank0e.loc_8c0e6408,pc),r3
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
mov.l @r15,r2
...
loc_8c0e6718:
mov.w @(bank0e.loc_8c0e6856,pc),r0
mov.b @(r0,r13),r3
tst r3,r3
bt loc_8c0e6750
mov.b @r12,r2
...
mov.b @(r0,r13),r2
mov 0x17,r5
mov.l @(bank0e.loc_8c0e6868,pc),r0
mov.l @(bank0e.loc_8c0e686c,pc),r3
mov.b r2,@r12
mov.b @r12,r6
extu.b r6,r6
mov.b @(r0,r6),r6
...
loc_8c0e6a78:
mov.l @(bank0e.loc_8c0e6b10,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
lds.l @r15+,pr 
...
mov.l r3,@r15
mov.b @(r0,r13),r2
mov.l @(bank0e.loc_8c0e6b14,pc),r3
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
mov 0x34,r0
...
mov 0x02,r6
sts.l pr,@-r15
mov.l @(bank0e.loc_8c0e7070,pc),r3
mov r4,r14
jsr @r3
mov 0x04,r5
tst r0,r0
...
mov 0x26,r0
mov.l @(bank0e.loc_8c0e7074,pc),r3
mov.l r3,@(0x10,r4) 
mov 0x01,r3
mov.l r14,@(0x18,r4) 
mov.w r2,@(r0,r4) 
...
mov 0x24,r0
mov.b r4,@(r0,r14) 
mov.w @(bank0e.loc_8c0e71a4,pc),r0
mov.l @(bank0e.loc_8c0e71b0,pc),r5
mov.l @(r0,r14),r4
add 0x60,r0
mov r4,r3
shll2 r3
...
fmov.s @(r0,r14),fr2
mov r14,r2
mov.w @(bank0e.loc_8c0e71a4,pc),r3
float fpul,fr3
lds r1,fpul 
add r14,r3
fsts fpul,fr0
...
mov.b r3,@(r0,r14) 
mov.b @(r0,r14),r6
mov.l @(bank0e.loc_8c0e71bc,pc),r3
add 0x06,r6
jsr @r3
mov r14,r4
...
loc_8c0e76e2:
mov r13,r5
bsr bank0e.loc_8c0e7416
mov r14,r4
bra bank0e.loc_8c0e7766
nop 
...
mov r5,r13
sts.l pr,@-r15
mov.l @(bank0e.loc_8c0e78cc,pc),r3
mov 0x03,r5
mov 0x00,r6
jsr @r3
mov r6,r4
...
bt/s loc_8c0e77f0
mov r0,r4
mov.l @(bank0e.loc_8c0e78d0,pc),r5
tst r13,r13
bt loc_8c0e77be
mov.l @(bank0e.loc_8c0e78d4,pc),r5
...
mov.l r14,@(0x18,r4) 
mov.w r2,@(r0,r4) 
mov.w @(bank0e.loc_8c0e78b4,pc),r0
mov.w @(r0,r14),r3
mov.w @(bank0e.loc_8c0e78b6,pc),r0
extu.w r3,r3
mov.l r3,@(r0,r4) 
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0e.loc_8c0e7ab0,pc),r3
jsr @r3
mov r4,r14
...
mov.b @(0x05,r14),r0 
mov r14,r4
mov.l @(bank0e.loc_8c0e7ab8,pc),r3
mov 0x1B,r5
add 0x01,r0
mov.b r0,@(0x05,r14) 
...
loc_8c0e7c54:
mov.b @(0x05,r14),r0 
mov.l @(bank0e.loc_8c0e7d24,pc),r12
tst r0,r0
bf loc_8c0e7cd2
mov 0x68,r0
fmov.s @(r0,r14),fr3
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0e7d28,pc),r3
mov.l @r15+,r8
mov.l @r15+,r12
mov.l @r15+,r13
jmp @r3
...
tst r3,r3
bt loc_8c0e819e
mov.w @(bank0e.loc_8c0e829e,pc),r0
mov 0x00,r3
mov.b r3,@(r0,r14) 

loc_8c0e819e:
mov 0x34,r0
mov.l @(bank0e.loc_8c0e82a4,pc),r3
fmov.s @(r0,r13),fr3
mov 0x17,r5
mov 0x07,r6
fmov.s fr3,@(r0,r14) 
...
#align4
loc_8c0e81f4:
mov.w @(bank0e.loc_8c0e82a2,pc),r0
mov 0x09,r1
mov.b r1,@(r0,r14) 
...
mov.w @(loc_8C0E8A8C,pc),r0
mov 0x1B,r5
mov.l @(bank0e.loc_8c0e8a9c,pc),r3
mov.b @(r0,r14),r6
extu.b r6,r6
jsr @r3
mov r14,r4
...
loc_8c0e9098:
mov.l @(bank0e.loc_8c0e9118,pc),r3
mov 0x12,r5
fmov.s fr3,@(r0,r14) 
mov 0x0A,r6
jsr @r3
...
mov.l @(bank0e.loc_8c0e911c,pc),r2
add r5,r3
mov.l r4,@r15
mov.l r3,@(0x04,r15) 
jsr @r2
...
cmp/eq 0x01,r0 
bf loc_8c0e95fc
mov.w @(bank0e.loc_8c0e963a,pc),r0
mov.b @(r0,r5),r0
extu.b r0,r0
cmp/eq 0x1E,r0 
bt bank0e.loc_8c0e960c
...
loc_8c0e9f02:
mov.l @(bank0e.loc_8c0e9fdc,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf/s loc_8c0e9f14
...
loc_8c0e9f14:
bsr bank0e.loc_8c0ea1c6
nop 
lds.l @r15+,pr 
mov r14,r4
bra bank0e.loc_8c0ea098
mov.l @r15+,r14
...
#align4
loc_8c0e9f6c:
mov.l @(bank0e.loc_8c0e9fdc,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bf loc_8c0e9f7c
...
loc_8c0e9fe0:
mov.l @(bank0e.loc_8c0ea0cc,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf/s loc_8c0e9ff2
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0e.loc_8c0ea0dc,pc),r3
jsr @r3
mov r4,r14
...
#align4
loc_8c0ea90c:
mov.w @(bank0e.loc_8c0ea9b4,pc),r0
mov 0x07,r3
mov.l r14,@-r15
mov.l @(r0,r4),r5
mov 0x24,r0
...
loc_8c0ea958:
mov.l @(bank0e.loc_8c0ea9d8,pc),r3
mov 0x16,r5
mov r14,r6
jmp @r3
mov.l @r15+,r14
...
sts.l pr,@-r15
mov.b @(r0,r14),r3
mov.l @(bank0e.loc_8c0eaaec,pc),r12
tst r3,r3
bf/s loc_8c0eaac8
mov r5,r13
...
cmp/eq 0x1E,r0 
bf loc_8c0eaa44
mov.l @(bank0e.loc_8c0eaaf8,pc),r2
mov 0x16,r5
mov 0x13,r6
jsr @r2
mov r14,r4
...
bt loc_8c0eaa72
mov.w @(0x1E,r14),r0 
mov.l @(bank0e.loc_8c0eaafc,pc),r3
xor 0x01,r0 
mov.w r0,@(0x1E,r14) 
mov.w @(0x1E,r14),r0 
mov r0,r5
...
mov.b @(0x05,r14),r0 
mov 0x02,r3
mov.l @(bank0e.loc_8c0eaaf8,pc),r1
mov 0x12,r6
add 0x01,r0
mov r14,r4
mov.b r0,@(0x05,r14) 
...
loc_8c0eab00:
mov r13,r2
mov.l @(bank0e.loc_8c0eabe8,pc),r3
mov r14,r1
add 0x34,r2
add 0x34,r1
jsr @r3
...
loc_8c0eb20e:
mov 0x34,r0
mov.l @(bank0e.loc_8c0eb288,pc),r3
fmov.s @(r0,r13),fr3
fadd fr4,fr3
fmov.s fr3,@(r0,r14) 
...
mov 0x34,r0
fmov.s @(r0,r5),fr3
mov.l @(bank0e.loc_8c0eb600,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r5),fr3
fmov.s fr3,@(r0,r14) 
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0e.loc_8c0eb5ee,pc),r0
mov.b r3,@(r0,r14) 
...
mov 0x34,r0
fmov.s @(r0,r5),fr3
mov.l @(bank0e.loc_8c0eb710,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r5),fr3
fmov.s fr3,@(r0,r14) 
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0e.loc_8c0eb6fe,pc),r0
mov.b r3,@(r0,r14) 
...
mov 0x34,r0
fmov.s @(r0,r5),fr3
mov.l @(bank0e.loc_8c0eb824,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r5),fr3
fmov.s fr3,@(r0,r14) 
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0e.loc_8c0eb810,pc),r0
mov.b r3,@(r0,r14) 
...
#align4
loc_8c0eba04:
mov.l @(bank0e.loc_8c0ebb20,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0e.loc_8c0ebb0c,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c0ebbd0:
mov 0x24,r0
mov.l @(bank0e.loc_8c0ebc78,pc),r7
mov.b @(r0,r5),r3
mov.b r3,@(r0,r4) 
mov 0x34,r0
fmov.s @(r0,r5),fr3
...
fmac fr0,fr3,fr2
fmov.s fr2,@r3
mov.l @(bank0e.loc_8c0ebc84,pc),r3
jmp @r3
nop 
#data 0x000B
#data 0x0009
...
mov.w r5,@r15
mov 0x03,r5
mov.l @(bank0e.loc_8c0ec570,pc),r3
mov r4,r14
mov 0x02,r6
jsr @r3
mov r14,r4
...
bt/s loc_8c0ec4a2
mov r0,r4
mov.l @(bank0e.loc_8c0ec574,pc),r3
mov 0x20,r0
mov.l r3,@(0x10,r4) 
mov.w @r15,r2
extu.w r2,r2
...
cmp/pz r0
bt loc_8c0ec70a
mov.l @(bank0e.loc_8c0ec7b8,pc),r3
mov.w @(0x1E,r14),r0 
jsr @r3
mov.w r0,@(0x1C,r14) 
tst 0x01,r0 
...
fmov.s @(r0,r12),fr3
mov 0x38,r0
mov.l @(bank0e.loc_8c0ec7bc,pc),r3
fmov.s fr3,@(r0,r14) 
mov.b @(0x05,r14),r0 
add 0x01,r0
mov.b r0,@(0x05,r14) 
...
loc_8c0ec78a:
mov.l @(bank0e.loc_8c0ec7c0,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt loc_8c0ec7a6
lds.l @r15+,pr 
mov.l @(bank0e.loc_8c0ec7c4,pc),r3
mov r14,r4
mov.l @r15+,r11
mov.l @r15+,r12
mov.l @r15+,r13
...
add 0x01,r0
mov.l @(bank0e.loc_8c0ecff4,pc),r3
mov.b r0,@(0x04,r14) 
mov 0x00,r0
mov.b r0,@(0x05,r14) 
add r14,r1
...
add 0x50,r2
mov.b r3,@(r0,r14) 
mov.l @(bank0e.loc_8c0ecff8,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov.l @(bank0e.loc_8c0ecffc,pc),r3
mov.b @(r0,r12),r2
mov 0x19,r5
mov 0x04,r6
mov.b r2,@(r0,r14) 
...
loc_8c0ecf96:
mov 0x24,r0
mov.l @(bank0e.loc_8c0ed000,pc),r3
mov.b @(r0,r12),r2
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
...
tst r2,r2
bt loc_8c0ecfb2
mov.l @(bank0e.loc_8c0ed004,pc),r3
mov 0x04,r5
jsr @r3
mov r12,r4
...
tst r0,r0
bf loc_8c0ed048
mov.l @(bank0e.loc_8c0ed054,pc),r3
jsr @r3
nop 
mov.l @(bank0e.loc_8c0ed058,pc),r1
and 0x07,r0 
shll2 r0
fmov.s @(r0,r1),fr4
...
jsr @r3
fmov.s fr3,@(r0,r14) 
mov.l @(bank0e.loc_8c0ed05c,pc),r1
and 0x07,r0 
shll2 r0
fmov.s @(r0,r1),fr3
mov 0x38,r0
...
bf loc_8c0ed98c
mov 0xFC,r2
mov.l @(bank0e.loc_8c0ed9cc,pc),r0
shad r2, r4
...
bf loc_8c0ed98c
mov 0x02,r5
bsr bank0e.loc_8c0ed3e4
mov r14,r4
tst r0,r0
bt/s loc_8c0ed98c
mov r0,r12
mov.l @(bank0e.loc_8c0ed9d0,pc),r2
mov r15,r13
jsr @r2
add 0x04,r13
and 0x0F,r0 
...
#align4
loc_8c0edc94:
mov.w @(bank0e.loc_8c0edd9c,pc),r0
mov 0x01,r3
mov r13,r5
mov.b r3,@(r0,r14) 
bsr bank0e.loc_8c0eddfe
mov r14,r4
tst r0,r0
bf loc_8c0edd32
mov.l @(bank0e.loc_8c0edda4,pc),r3
jsr @r3
mov r14,r4
...
fmov.s fr4,@(r0,r14) 
mov 0x68,r0
mov.l @(bank0e.loc_8c0edda8,pc),r3
fmov.s fr4,@(r0,r14) 
lds.l @r15+,pr 
mov.l @r15+,r12
mov.l @r15+,r13
...
loc_8c0efad4:
mov.l @(bank0e.loc_8c0efc78,pc),r3
mov.l @r14,r0
jsr @r3
mov.l @(r0,r13),r4
...
cmp/eq 0x01,r0 
bf loc_8c0efb60
mov.l @(bank0e.loc_8c0efc84,pc),r1
mov 0x05,r5
mov.l @(bank0e.loc_8c0efc80,pc),r14
mov 0x04,r6
mov.l r1,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc88,pc),r3
mov 0x06,r5
mov 0x04,r6
mov.l r3,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc8c,pc),r2
mov 0x07,r5
mov 0x04,r6
mov.l r2,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc90,pc),r3
mov 0x08,r5
mov 0x04,r6
mov.l r3,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc94,pc),r2
mov 0x09,r5
mov 0x04,r6
mov.l r2,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc98,pc),r3
mov 0x0A,r5
mov 0x04,r6
mov.l r3,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efc9c,pc),r2
mov 0x0B,r5
mov 0x04,r6
mov.l r2,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efca0,pc),r3
mov 0x0C,r5
mov 0x04,r6
mov.l r3,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efca4,pc),r2
mov 0x0D,r5
mov 0x04,r6
mov.l r2,@-r15
jsr @r14
mov 0x14,r4
mov.l @(bank0e.loc_8c0efca8,pc),r3
mov 0x0E,r5
mov 0x04,r6
mov.l r3,@-r15
jsr @r14
...
loc_8c0eff40:
mov.l @(bank0e.loc_8c0f0044,pc),r2
mov.l @r15+,r12
mov.l @(0x18,r14),r4
jmp @r2
mov.l @r15+,r14
...
mov.b r11,@(r0,r3) 
mov.l @r15+,r11
mov.l @(bank0e.loc_8c0f0044,pc),r3
mov.l @r15+,r13
mov.l @(0x18,r14),r4
jmp @r3
mov.l @r15+,r14
