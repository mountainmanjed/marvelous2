...
;==============================================
loc_8c0ef1b4:
	mov.w @(loc_8c0ef2a0,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r10,r5
	mov.w @(loc_8c0ef2a2,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(0xfc,PC),r5;8c0ef2c4
	bra loc_8c0ef20e
	mov r10,r6

;==============================================
loc_8c0ef1ca:
	mov.w @(loc_8c0ef2a4,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2a6,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(loc_8c0ef2c8,PC),r5
	mov r13,r6
	bra loc_8c0ef20e
	nop 
...
;==============================================
loc_8c0ef1e2:
	mov.w @(loc_8c0ef2a8,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2aa,PC),r4
	mov.l @(loc_8c0ef2cc,PC),r5;Pl_Dat?
	jsr @r14
	mov 0x00,r6
	mov.w @(loc_8c0ef2ac,PC),r4
	mov.l @(loc_8c0ef2d0,PC),r5
	bra loc_8c0ef258
	mov r13,r6

;==============================================
loc_8c0ef1fa:
	mov.w @(loc_8c0ef2ae,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2b0,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(loc_8c0ef2d4,PC),r5
	mov r13,r6
...
;==============================================
loc_8c0ef212:
	mov.w @(loc_8c0ef2b2,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2b4,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(loc_8c0ef2d8,PC),r5
	mov r13,r6
	bra loc_8c0ef258
	mov r11,r4
...
;==============================================
loc_8c0ef22a:
	mov.w @(loc_8c0ef2b6,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2b8,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(loc_8c0ef2dc,PC),r5
	mov r13,r6
	bra loc_8c0ef258
	mov r11,r4
...
;==============================================
loc_8c0ef242:
	mov.w @(loc_8c0ef2ba,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r13,r5
	mov.w @(loc_8c0ef2bc,PC),r4
	mov 0x00,r6
	jsr @r14
	mov r12,r5
	mov.l @(loc_8c0ef2e0,PC),r5
	mov r11,r4
	mov r13,r6
...
;----------------------------------------------
loc_8C0EF278:
	mov.w @(loc_8c0ef2be,PC),r3
	extu.w r4,r7
	mov.w @(loc_8c0ef2be,PC),r2
	and r7,r3
	cmp/eq r2,r3
	bf loc_8c0ef28c
	add 0xFF,r5
