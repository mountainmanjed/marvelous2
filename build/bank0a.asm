...
mov r14,r2
mov 0x38,r0
mov.l @(bank0a.loc_8c0a0264,pc),r4
add r0,r2
mov.l r2,@-r15
mov 0x21,r2
mov.b @r3,r3
...
loc_8c0a0200:
mov.l @(bank0a.loc_8c0a0268,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
...
mov r7,r0
nop 
mov.l @(bank0a.loc_8c0a0a3c,pc),r3
mov 0x01,r6
mov.w r0,@(0x04,r15) 
mov r6,r5
jsr @r3
...
mov 0x26,r0
mov.l @(bank0a.loc_8c0a0a40,pc),r3
mov 0x20,r1
add r4,r1
mov.l r3,@(0x10,r4) 
mov.w r2,@(r0,r4) 
...
tst r3,r3
bf loc_8c0a1390
mov.l @(bank0a.loc_8c0a13e8,pc),r2
jsr @r2
mov r14,r4
mov.w @(loc_8C0A13E2,pc),r0
mov.b @(r0,r14),r3
tst r3,r3
bt bank0a.loc_8c0a1396
...
mov.l @(bank0a.loc_8c0a1834,pc),r2
mov.b r4,@(r0,r14) 
add 0x01,r0
mov.b r4,@(r0,r14) 
jsr @r2
...
mov 0x68,r1
add r14,r1
mov.l @(bank0a.loc_8c0a1838,pc),r3
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
mov 0x5C,r0
fmov.s @(r0,r14),fr2
...
tst r2,r2
bf loc_8c0a17ea
mov.l @(bank0a.loc_8c0a183c,pc),r2
jsr @r2
mov r14,r4
...
loc_8c0a17f2:
mov.l @(bank0a.loc_8c0a1840,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bf loc_8c0a1808
...
loc_8c0a1bae:
mov.w @(bank0a.loc_8c0a1c76,pc),r0
mov 0x43,r2
mov.b r2,@(r0,r14) 
...
mov 0x34,r0
fmov.s @(r0,r4),fr3
mov.l @(bank0a.loc_8c0a1c8c,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r4),fr3
fmov.s fr3,@(r0,r14) 
...
mov 0x38,r0
add r0,r3
mov.l @(bank0a.loc_8c0a1c90,pc),r0
exts.w r4,r4
mov.l r3,@-r15
shll r4
mov.w @(r0,r4),r2
...
loc_8c0a1c40:
mov.l @(bank0a.loc_8c0a1ca0,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
mov.l @r15,r5
...
mov.b @(0x05,r14),r0 
mov 0x15,r5
mov.l @(bank0a.loc_8c0a21dc,pc),r3
mov 0x03,r6
add 0x01,r0
mov.b r0,@(0x05,r14) 
jsr @r3
...
loc_8c0a2230:
mov.w @(0x1E,r14),r0 
mov.l @(bank0a.loc_8c0a230c,pc),r3
mov r0,r5
jsr @r3
mov r14,r4
...
loc_8c0a228c:
mov.l @(bank0a.loc_8c0a2318,pc),r3
jsr @r3
mov r14,r4
bra loc_8c0a22ee
nop 
...
mov 0x01,r5
sts.l pr,@-r15
mov.l @(bank0a.loc_8c0a2b80,pc),r3
jsr @r3
mov r6,r4
tst r0,r0
bt/s loc_8c0a2b58
...
mov 0x26,r0
mov.l @(bank0a.loc_8c0a2b90,pc),r3
mov.l r3,@(0x10,r14) 
mov.l r12,@(0x18,r14) 
mov.w r2,@(r0,r14) 
mov 0x20,r0
...
loc_8c0a2b24:
mov.l @(bank0a.loc_8c0a2ba0,pc),r3
jsr @r3
nop 
and 0x07,r0 
lds r0,fpul 
...
tst r2,r2
bf loc_8c0a2cfe
mov.l @(bank0a.loc_8c0a2da4,pc),r3
jsr @r3
mov r14,r4

loc_8c0a2cfe:
mov.l @(bank0a.loc_8c0a2da8,pc),r2
jsr @r2
mov r14,r4
...
#align4
loc_8c0a2d5c:
mov.l @(bank0a.loc_8c0a2db4,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bf loc_8c0a2d74
mov.l @(bank0a.loc_8c0a2db4,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt bank0a.loc_8c0a2d80
...
cmp/eq r2,r3
bt loc_8c0a329c
mov.l @(bank0a.loc_8c0a3354,pc),r3
mov 0x17,r5
mov 0x00,r6
mov.b r4,@(r0,r14) 
mov.b @(r0,r14),r7
...
loc_8c0a329c:
mov r13,r2
mov.l @(bank0a.loc_8c0a335c,pc),r3
mov r14,r1
add 0x34,r2
add 0x34,r1
jsr @r3
mov 0x0C,r0
mov.w @(loc_8C0A334C,pc),r0
mov.l @(bank0a.loc_8c0a3360,pc),r4
mov.b @(r0,r13),r2
mov 0x20,r0
mov.b @(r0,r14),r3
...
fmac fr0,fr3,fr2
fmov.s fr2,@r3
mov.w @(bank0a.loc_8c0a3350,pc),r0
mov r14,r4
mov.l @(bank0a.loc_8c0a336c,pc),r3
mov.b r2,@(r0,r14) 
lds.l @r15+,pr 
mov.l @r15+,r12
mov.l @r15+,r13
...
mov.l @(bank0a.loc_8c0a3734,pc),r4
mov.b @(r0,r13),r0
extu.b r0,r0
cmp/eq 0x02,r0 
bt loc_8c0a35cc
mov.l @(bank0a.loc_8c0a3738,pc),r4
...
add 0x06,r0
mov.b @(r0,r13),r3
mov.l @(bank0a.loc_8c0a3744,pc),r0
extu.b r3,r3
mov.b @(r0,r3),r2
...
loc_8c0a3696:
shar r9
mov.l @(bank0a.loc_8c0a374c,pc),r1
shar r9
shar r9
mov 0x1B,r5
extu.b r9,r7
...
extu.b r9,r4
mov.l @(bank0a.loc_8c0a3750,pc),r3
shll2 r4
shll r4
...
shll2 r0
add r3,r0
mov.l @(bank0a.loc_8c0a3754,pc),r3
mov.l r0,@r1
add r3,r4
mov.w @r4,r2
lds r2,fpul 
...
loc_8c0a3778:
mov 0x03,r0
mov.l @(bank0a.loc_8c0a386c,pc),r3
mov.b r0,@(0x06,r13) 
mov r14,r4
lds.l @r15+,pr 
fmov.s @r15+,fr14
...
loc_8c0a3ee0:
mov.l @(bank0a.loc_8c0a3ff4,pc),r3
mov r12,r5
mov.l @(0x28,r12),r6
jsr @r3
mov r14,r4
mov 0x2C,r1
mov.l @(bank0a.loc_8c0a3ff8,pc),r3
add r12,r1
fmov.s @r1,fr3
mov 0x34,r0
mov r0,r1
...
jsr @r3
mov r13,r4
mov.w @(bank0a.loc_8c0a3fe4,pc),r0
mov 0x01,r4
mov.b r4,@(r0,r14) 
mov 0x34,r0
mov.b r4,@(r0,r12) 
...
mov 0x22,r0
mov.b @(r0,r5),r5
mov.w @(bank0a.loc_8c0a411a,pc),r0
add r10,r5
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0a4092
...
mov.w @(r0,r14),r2
mov.l @(bank0a.loc_8c0a43bc,pc),r0
extu.w r2,r2
cmp/gt r2,r3
addc r3,r2
mov.l @(bank0a.loc_8c0a43c0,pc),r3
shar r2
mov.b @(r0,r2),r1
...
loc_8c0a42d0:
shar r12
mov.l @(bank0a.loc_8c0a43c4,pc),r2
shar r12
shar r12
mov 0x1B,r5
extu.b r12,r7
...
extu.b r12,r4
mov.l @(bank0a.loc_8c0a43c8,pc),r3
shll2 r4
shll r4
...
shll2 r0
add r3,r0
mov.l @(bank0a.loc_8c0a43d0,pc),r3
mov.l r0,@r1
...
mov 0x22,r0
mov.b @(r0,r5),r5
mov.w @(bank0a.loc_8c0a48e8,pc),r0
add r10,r5
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0a4862
...
mov.b r3,@(r0,r4) 
add 0xCF,r0
mov.l @(bank0a.loc_8c0a4b2c,pc),r3
mov.b r2,@(r0,r4) 
jsr @r3
mov r14,r4
mov 0x02,r4
...
tst 0x07,r0 
bf loc_8c0a4c5a
mov.l @(bank0a.loc_8c0a4d04,pc),r2
mov 0x1E,r5
jsr @r2
mov r12,r4
mov r14,r5
...
loc_8c0a4c5a:
mov.l @(bank0a.loc_8c0a4d08,pc),r3
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0a4d0c,pc),r3
mov.l @r15+,r8
mov.l @r15+,r9
mov.l @r15+,r10
mov.l @r15+,r11
...
loc_8c0a4c9a:
mov.l @(bank0a.loc_8c0a4d10,pc),r2
jsr @r2
mov r12,r4
tst r0,r0
bt loc_8c0a4cac
...
tst r9,r0
bf loc_8c0a4cee
mov.l @(bank0a.loc_8c0a4d14,pc),r2
mov r14,r6
mov r13,r5
add 0x08,r6
jsr @r2
...
loc_8c0a4d0c:
#data bank0a.loc_8c0a3ab8

loc_8c0a4d10:
#data bank05.loc_8c050682

loc_8c0a4d14:
#data bank0a.loc_8c0a5598


loc_8c0a4d18:
mov.l @(bank0a.loc_8c0a4e34,pc),r1
mov.b @(r0,r1),r3
mov.l @(bank0a.loc_8c0a4e38,pc),r0
extu.b r3,r3
mov.b @(r0,r3),r2
...
loc_8c0a4d36:
shar r0
mov.l @(bank0a.loc_8c0a4e3c,pc),r3
shar r0
shar r0
extu.b r0,r7
mov.b r0,@r15
...
mov.l @(0x28,r14),r6
mov r14,r5
bsr bank0a.loc_8c0a4fe2
mov r13,r4
mov 0x2C,r1
mov.l @(bank0a.loc_8c0a4e44,pc),r3
add r14,r1
fmov.s @r1,fr3
mov 0x34,r0
mov r0,r1
...
cmp/eq 0x09,r0 
bf loc_8c0a4e12
mov.l @(bank0a.loc_8c0a4e48,pc),r2
mov 0x01,r5
jsr @r2
mov r14,r4
...
mov 0xFE,r5
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0a4e4c,pc),r3
mov.l @(r0,r14),r4
jmp @r3
mov.l @r15+,r14

loc_8c0a4e12:
mov.l @(bank0a.loc_8c0a4e50,pc),r3
mov 0x01,r5
jsr @r3
mov r14,r4
mov.w @(loc_8C0A4E30,pc),r0
...
mov.l @(0x08,r4),r6
mov.b @(r0,r10),r3
mov.w @(bank0a.loc_8c0a4f8e,pc),r7
mov.b r3,@(r0,r4) 
add r6,r7
mov.w @(0x04,r7),r0 
mov r0,r3
...
mov.l @(bank0a.loc_8c0a4fa0,pc),r3
mov.b r2,@(r0,r13) 
jsr @r3
mov r13,r4
mov 0x32,r0
...
mov.b @(r0,r14),r3
mov.l @(bank0a.loc_8c0a50dc,pc),r0
add r14,r2
add r3,r4
extu.b r4,r4
shlr2 r4
...
mov.b r3,@r2
mov.l @(bank0a.loc_8c0a50e0,pc),r3
mov.l @(r0,r12),r5
jsr @r3
mov r14,r4
mov.l @r15,r4
...
bt loc_8c0a5128
mov.w @(loc_8C0A50D2,pc),r0
mov.l @(bank0a.loc_8c0a50e4,pc),r1
mov.l @(r0,r12),r11
...
add 0x34,r2
add r3,r12
mov.l @(bank0a.loc_8c0a50e8,pc),r3
add 0x34,r1
jsr @r3
mov 0x0C,r0
extu.b r11,r5
mov.l @(bank0a.loc_8c0a50ec,pc),r2
shll2 r5
...
fsub fr3,fr1
fmov.s fr1,@r1
mov.l @(bank0a.loc_8c0a50fc,pc),r1
extu.b r12,r0
shll r0
...
loc_8c0a5104:
mov.l @(bank0a.loc_8c0a513c,pc),r3
extu.b r12,r12
mov.l @(bank0a.loc_8c0a5138,pc),r0
shll r12
add r12,r3
extu.b r11,r11
mov.b @r3,r3
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0a5140,pc),r3
mov.l @r15+,r11
mov.l @r15+,r12
mov.l @r15+,r13
jmp @r3
...
loc_8c0a541a:
mov.w @(bank0a.loc_8c0a54e8,pc),r0
mov.w @(r0,r4),r0
extu.w r0,r0
tst 0x60,r0 
bt loc_8c0a5444
...
loc_8c0a5426:
mov.w @(bank0a.loc_8c0a54e2,pc),r0
mov.l @(r0,r4),r3
add 0x72,r0
mov.b @(r0,r3),r2
add 0x02,r2
...
nop 
mov.w r0,@(0x16,r5) 
mov.w @(bank0a.loc_8c0a54e4,pc),r0
mov.w @(r0,r4),r0
mov.w r0,@(0x14,r5) 
mov r7,r0
nop 
...
mov 0x01,r5
sts.l pr,@-r15
mov.l @(bank0a.loc_8c0a566c,pc),r3
mov r4,r14
mov 0x00,r6
jsr @r3
mov r6,r4
...
mov.l @(bank0a.loc_8c0a5670,pc),r3
mov.l r3,@(0x10,r4) 
mov 0x03,r3
mov.l @(0x18,r14),r2
mov.l r2,@(0x18,r4) 
...
#align4
loc_8c0a56b8:
mov.w @(bank0a.loc_8c0a57bc,pc),r0
mov.w @(r0,r4),r2
mov.w @(0x1C,r14),r0 
extu.w r2,r2
cmp/eq r0,r2
bf loc_8c0a56ce
mov.w @(bank0a.loc_8c0a57be,pc),r0
mov.b @(r0,r4),r0
extu.b r0,r0
cmp/eq 0x15,r0 
bt bank0a.loc_8c0a56d4
...
#align4
loc_8c0a59d8:
mov.l @(bank0a.loc_8c0a5a20,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0a.loc_8c0a5a0c,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c0a5b0a:
mov.l @(bank0a.loc_8c0a5b74,pc),r0
extu.b r5,r5
shll r5
mov.w @(r0,r5),r3
...
loc_8c0a5b2a:
mov 0x34,r0
mov.l @(bank0a.loc_8c0a5b7c,pc),r3
fmov.s @(r0,r4),fr3
mov 0x12,r5
mov r14,r7
mov 0x05,r6
...
add 0x01,r0
mov.b r0,@(0x04,r4) 
mov.w @(bank0a.loc_8c0a5c6a,pc),r0
mov.b r3,@(r0,r4) 
...
mov.l @(0x18,r4),r2
mov r4,r1
mov.l @(bank0a.loc_8c0a5f38,pc),r3
add 0x34,r1
add 0x34,r2
jsr @r3
mov 0x0C,r0
mov.w @(bank0a.loc_8c0a5f28,pc),r0
mov r4,r1
mov.l @(bank0a.loc_8c0a5f3c,pc),r2
mov.l @(r0,r4),r5
mov 0x21,r0
mov.b @(r0,r4),r3
...
loc_8c0a5f92:
mov.l @(bank0a.loc_8c0a6094,pc),r2
mov 0x01,r6
mov r6,r5
jsr @r2
mov 0x00,r4
...
bt/s loc_8c0a5fca
mov r0,r4
mov.l @(bank0a.loc_8c0a6098,pc),r2
mov 0x20,r0
mov r4,r1
add 0x34,r1
mov.l r2,@(0x10,r4) 
...
mov.w r2,@(r0,r4) 
mov r14,r2
mov.l @(bank0a.loc_8c0a609c,pc),r3
add 0x34,r2
jsr @r3
mov 0x0C,r0
...
loc_8c0a7064:
mov.l @(bank0a.loc_8c0a7190,pc),r3
jsr @r3
mov r14,r4
...
mov 0x21,r0
mov.b @(r0,r14),r3
mov.l @(bank0a.loc_8c0a7194,pc),r0
extu.b r3,r3
mov.b @(r0,r3),r2
mov 0x22,r0
mov.b r2,@(r0,r14) 
...
fmov.s fr4,@(r0,r14) 
mov 0x6C,r0
mov.l @(bank0a.loc_8c0a719c,pc),r3
...
nop 
mov r13,r4
mov.l @(bank0a.loc_8c0a71a0,pc),r3
mov.b r0,@(0x07,r14) 
mov 0x21,r5
lds.l @r15+,pr 
mov.l @r15+,r9
...
#align4
loc_8c0a7500:
mov.l @(bank0a.loc_8c0a7534,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.w @(0x1E,r14),r0 
mov 0x34,r2
mov.l @(bank0a.loc_8c0a7718,pc),r1
add r14,r2
fmov.s @r2,fr2
mov.b @(r0,r1),r3
lds r3,fpul 
...
tst r0,r0
bf loc_8c0a76ae
mov.w @(bank0a.loc_8c0a7710,pc),r0
mov 0x00,r2
mov.b r2,@(r0,r14) 
mov 0x03,r0
mov.b r0,@(0x04,r14) 
...
bf/s loc_8c0a76ee
mov 0x02,r13
mov.l @(bank0a.loc_8c0a7720,pc),r3
jsr @r3
mov r14,r4
...
mov 0x22,r0
mov.b r3,@(r0,r14) 
mov.w @(bank0a.loc_8c0a79a6,pc),r0
mov.w @(r0,r13),r2
tst r2,r2
bt loc_8c0a78a2
mov 0x22,r0
...
loc_8c0a78a2:
mov 0x34,r0
mov.l @(bank0a.loc_8c0a79ac,pc),r4
fmov.s @(r0,r13),fr3
fmov.s fr3,@(r0,r14) 
mov 0x21,r0
mov.b @(r0,r14),r3
...
loc_8c0a78fc:
mov 0x5C,r1
mov.l @(bank0a.loc_8c0a79b8,pc),r3
add r14,r1
mov 0x34,r0
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
...
loc_8c0a797a:
mov.l @(bank0a.loc_8c0a79c4,pc),r3
mov 0x0F,r2
mov 0x17,r5
and r2,r7
mov 0x03,r6
jsr @r3
mov r14,r4
mov.l @(bank0a.loc_8c0a79c8,pc),r2
jsr @r2
nop 
mov 0x07,r4
and r0,r4
...
#align4
loc_8c0a7aa4:
mov.l @(bank0a.loc_8c0a7b2c,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.w @(0x1E,r14),r0 
mov 0x34,r2
mov.l @(bank0a.loc_8c0a7c68,pc),r1
add r14,r2
fmov.s @r2,fr2
mov.b @(r0,r1),r3
lds r3,fpul 
...
tst r0,r0
bf loc_8c0a7c42
mov.w @(bank0a.loc_8c0a7c5a,pc),r0
mov 0x00,r2
mov.b r2,@(r0,r14) 
mov 0x03,r0
mov.b r0,@(0x04,r14) 
...
nop 
mov 0x01,r6
mov.l @(bank0a.loc_8c0a7d9c,pc),r3
mov.b r0,@(0x04,r15) 
mov r6,r5
mov.b r7,@r15
jsr @r3
...
mov 0x26,r0
mov.l @(bank0a.loc_8c0a7da0,pc),r3
mov 0x20,r1
add r4,r1
mov.l r3,@(0x10,r4) 
mov.w r2,@(r0,r4) 
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
bra bank0a.loc_8c0a828e
mov.l @r15+,r14

loc_8c0a81b4:
mov.b @(0x05,r14),r0 
mov r14,r4
mov.l @(bank0a.loc_8c0a82ac,pc),r1
extu.b r0,r0
shll2 r0
mov.l @(r0,r1),r3
jmp @r3
...
mov r14,r2
mov 0x38,r0
mov.l @(bank0a.loc_8c0a88c8,pc),r4
add r0,r2
mov.l r2,@-r15
mov 0x21,r2
mov.b @r3,r3
...
loc_8c0a8870:
mov.l @(bank0a.loc_8c0a88cc,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
mov 0x01,r5
mov 0x00,r6
bsr bank0a.loc_8c0a85e6
mov r14,r4
mov 0x01,r5
mov 0x00,r6
bsr bank0a.loc_8c0a85e6
...
mov r7,r0
nop 
mov.l @(bank0a.loc_8c0a9084,pc),r3
mov 0x01,r6
mov.w r0,@(0x04,r15) 
mov r6,r5
jsr @r3
...
mov 0x26,r0
mov.l @(bank0a.loc_8c0a9088,pc),r3
mov 0x20,r1
add r4,r1
mov.l r3,@(0x10,r4) 
mov.w r2,@(r0,r4) 
...
mov.l @(bank0a.loc_8c0a9a98,pc),r2
mov.b r4,@(r0,r14) 
add 0x01,r0
mov.b r4,@(r0,r14) 
jsr @r2
...
mov 0x68,r1
add r14,r1
mov.l @(bank0a.loc_8c0a9a9c,pc),r3
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
mov 0x5C,r0
fmov.s @(r0,r14),fr2
...
tst r2,r2
bf loc_8c0a9a14
mov.l @(bank0a.loc_8c0a9aa0,pc),r2
jsr @r2
mov r14,r4
...
loc_8c0a9a1c:
mov.l @(bank0a.loc_8c0a9aa4,pc),r3
jsr @r3
mov r14,r4
tst r0,r0
bf loc_8c0a9a32
...
mov.b r12,@(r0,r14) 
mov 0x21,r0
mov.l @(bank0a.loc_8c0a9ec8,pc),r3
mov.b @(r0,r14),r6
jsr @r3
mov r14,r4
mov.l @(bank0a.loc_8c0a9ecc,pc),r3
mov 0x31,r0
mov 0xFE,r2
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
bsr bank0a.loc_8c0a9b38
mov r14,r4
tst r0,r0
bf loc_8c0a9e9e
mov 0x03,r0
...
loc_8c0aa1f4:
mov 0x68,r0
mov.l @(bank0a.loc_8c0aa258,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x08,r0
fmov.s @(r0,r4),fr3
mov 0x34,r0
...
cmp/gt r0,r3
bt loc_8c0aa466
mov.l @(bank0a.loc_8c0aa4dc,pc),r3
jsr @r3
mov r14,r4
mov.w @(bank0a.loc_8c0aa4d2,pc),r1
add r14,r1
mov.b r0,@r1
...
mov.b @(r0,r14),r3
tst r3,r3
bf bank0a.loc_8c0aa6b0
mov.b @(0x05,r5),r0 
extu.b r0,r0
cmp/eq 0x01,r0 
bf loc_8c0aa68e
mov.w @(bank0a.loc_8c0aa738,pc),r0
mov.b @(r0,r5),r0
extu.b r0,r0
cmp/eq 0x1E,r0 
bt bank0a.loc_8c0aa6a0
...
tst r3,r3
bf loc_8c0aa78c
mov.l @(bank0a.loc_8c0aa820,pc),r3
jsr @r3
mov r14,r4

loc_8c0aa78c:
mov.l @(bank0a.loc_8c0aa824,pc),r2
jsr @r2
mov r14,r4
mov.l @(bank0a.loc_8c0aa828,pc),r3
jsr @r3
mov r14,r4
...
fdiv fr6,fr5
mov.b @(r0,r13),r3
mov.l @(bank0a.loc_8c0aa928,pc),r0
extu.b r3,r3
shll2 r3
mov.w @(r0,r3),r3
lds r3,fpul 
...
mov r10,r0
nop 
mov.l @(bank0a.loc_8c0aa92c,pc),r3
jsr @r3
nop 
mov.w r0,@(0x18,r5) 
mov r0,r12
...
mov r10,r0
nop 
mov.l @(bank0a.loc_8c0aa934,pc),r3
jsr @r3
nop 
mov r0,r14
mov.w @(loc_8C0AA91C,pc),r0
exts.w r12,r3
mov.l @(bank0a.loc_8c0aa928,pc),r6
mov.b @(r0,r13),r2
lds r3,fpul 
mov.l @(bank0a.loc_8c0aa938,pc),r7
tst r2,r2
bf/s loc_8c0aa93c
float fpul,fr6
mov.b @(r0,r13),r3
...
tst r2,r2
bt loc_8c0aa9bc
mov.l @(bank0a.loc_8c0aaa54,pc),r3
jsr @r3
mov r14,r5
...
mov 0x04,r0
add r14,r5
mov.l @(bank0a.loc_8c0aaa58,pc),r3
mov r5,r4
add 0x08,r4
fmov.s @r4,fr3
mov r14,r12
...
cmp/pz r0
bf loc_8c0aaa32
mov.l @(bank0a.loc_8c0aaa5c,pc),r10
bra loc_8c0aaa2c
mov 0x00,r13
...
mov 0x34,r0
add r14,r1
mov.w @(bank0a.loc_8c0ab0f0,pc),r4
sts.l pr,@-r15
fmov.s @(r0,r14),fr2
add r14,r4
fmov.s @r1,fr3
...
lds.l @r15+,pr 
mov r14,r4
bra bank0a.loc_8c0aae6a
mov.l @r15+,r14

loc_8c0ab060:
mov.l @(bank0a.loc_8c0ab0fc,pc),r3
jsr @r3
mov r14,r4
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0ab100,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
...
mov.w r0,@(0x02,r6) 
mov 0x00,r3
mov.w @(bank0a.loc_8c0ab7c0,pc),r0
mov.b r3,@(r0,r5) 
...
tst r1,r4
bt loc_8c0ab842
mov.l @(bank0a.loc_8c0ab8e0,pc),r1
jsr @r1
mov r14,r4

loc_8c0ab842:
mov.l @(bank0a.loc_8c0ab8e4,pc),r3
jsr @r3
mov r14,r4
mov.w @(bank0a.loc_8c0ab8d6,pc),r1
add r14,r1
mov.b r0,@r1
...
tst r0,r0
bf loc_8c0ab8a2
mov.w @(bank0a.loc_8c0ab8d8,pc),r0
mov.b @(r0,r5),r0
extu.b r0,r0
cmp/eq 0x14,r0 
bt bank0a.loc_8c0ab8b2
...
loc_8c0ab8f0:
mov 0x21,r0
mov.w @(bank0a.loc_8c0ab9dc,pc),r3
mov.b @(r0,r4),r2
mov.l @(0x14,r4),r7
mov.l @(0x08,r4),r6
tst r2,r2
...
#align4
loc_8c0ac05c:
mov.w @(bank0a.loc_8c0ac192,pc),r0
mov.b @(r0,r13),r3
add 0xFE,r0
shll r3
add 0x34,r3
...
loc_8c0ac068:
mov.w @(bank0a.loc_8c0ac194,pc),r0
mov.w r4,@(r0,r14) 
add 0xF2,r0
mov.b r4,@(r0,r14) 
add 0x26,r0
...
loc_8c0ac1ec:
mov.l @(bank0a.loc_8c0ac2d8,pc),r2
mov 0x15,r5
extu.b r13,r6
jsr @r2
mov r14,r4
...
mov 0x00,r3
mov.b r3,@(r0,r14) 
bsr bank0a.loc_8c0abf94
mov r14,r4

loc_8c0ac206:
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0ac2dc,pc),r2
mov r14,r4
mov.l @r15+,r13
jmp @r2
mov.l @r15+,r14
...
mov.l @(0x14,r4),r6
mov 0x34,r0
mov.l @(bank0a.loc_8c0ac370,pc),r7
fmov.s @(r0,r6),fr3
fmov.s fr3,@(r0,r4) 
...
add 0x04,r15
lds.l @r15+,pr 
bra bank0a.loc_8c0ace04
mov.l @r15+,r14

loc_8c0acb2e:
mov 0x21,r0
mov.b @(r0,r14),r3
mov.l @(bank0a.loc_8c0acbb8,pc),r0
extu.b r3,r3
shll2 r3
mov.l @(r0,r3),r1
jsr @r1
mov r14,r4
mov.l @(bank0a.loc_8c0acbb4,pc),r3
mov.l @r3,r0
mov.l @(0x1C,r0),r0
tst 0x1F,r0 
bf loc_8c0acb80
mov.l @(bank0a.loc_8c0acbbc,pc),r1
jsr @r1
nop 
tst 0x03,r0 
bt/s loc_8c0acb5c
...
loc_8c0acb80:
mov.l @(bank0a.loc_8c0acbc4,pc),r3
jsr @r3
mov r14,r4
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0acbc8,pc),r3
jmp @r3
mov.l @r15+,r14
...
loc_8c0ace6e:
mov.l @(bank0a.loc_8c0acf34,pc),r3
jsr @r3
mov r14,r4
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0acf3c,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
...
mov r5,r0
nop 
mov.l @(bank0a.loc_8c0ad0a4,pc),r3
mov 0x01,r5
mov.b r0,@(0x04,r15) 
mov.b r6,@r15
mov 0x02,r6
...
mov r0,r4
mov 0x34,r0
mov.l @(bank0a.loc_8c0ad0a8,pc),r3
mov 0x20,r1
mov.l r3,@(0x10,r4) 
add r4,r1
fmov.s @(r0,r14),fr3
...
#align4
loc_8c0ae72c:
mov.l @(bank0a.loc_8c0ae808,pc),r3
jsr @r3
mov r14,r4
mov.l @r15,r2
mov.b @(0x03,r2),r0 
...
mov 0x02,r4
mov.l @(bank0a.loc_8c0ae814,pc),r3
mov.w r4,@(r0,r13) 
add 0x55,r0
mov.b r4,@(r0,r13) 
jsr @r3
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0ae818,pc),r3
mov.l @r15+,r12
mov.l @r15+,r13
jmp @r3
mov.l @r15+,r14
...
loc_8c0aef8e:
mov 0x34,r0
mov.l @(bank0a.loc_8c0af08c,pc),r3
fmov.s @(r0,r4),fr3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
fmov.s @(r0,r4),fr3
...
mov.l @r3,r2
extu.b r0,r0
mov.l @(bank0a.loc_8c0af30c,pc),r3
shll r0
add 0x7C,r2
mov.w @(r0,r2),r1
add 0x01,r1
...
mov 0x68,r0
fldi0 fr4
mov.l @(bank0a.loc_8c0af310,pc),r13
fmov.s fr4,@(r0,r14) 
mov 0x6C,r0
jsr @r13
fmov.s fr4,@(r0,r14) 
and 0x07,r0 
mov.l @(bank0a.loc_8c0af314,pc),r1
shll2 r0
shll r0
fmov.s @(r0,r1),fr4
...
fmov.s fr4,@(r0,r14) 
and 0x07,r0 
mov.l @(bank0a.loc_8c0af318,pc),r1
shll2 r0
shll r0
jsr @r13
fmov.s @(r0,r1),fr15
...
mov.b @(0x06,r14),r0 
mov 0x19,r5
mov.l @(bank0a.loc_8c0af584,pc),r3
mov 0x02,r6
add 0x01,r0
mov.b r0,@(0x06,r14) 
jsr @r3
...
loc_8c0af508:
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0af588,pc),r2
mov r14,r4
mov.l @r15+,r13
jmp @r2
mov.l @r15+,r14
...
#align4
loc_8c0af600:
mov.w @(bank0a.loc_8c0af694,pc),r0
mov 0x01,r1
mov.w r1,@(r0,r4) 
...
#align4
loc_8c0af678:
mov.w @(bank0a.loc_8c0af69a,pc),r0
mov.b @(r0,r4),r0
extu.b r0,r0
cmp/eq 0x17,r0 
bf loc_8c0af68a
mov.w @(bank0a.loc_8c0af69c,pc),r0
mov.w r5,@(r0,r4) 
add 0x55,r0
mov.b r5,@(r0,r4) 
...
mov r13,r5
lds.l @r15+,pr 
mov.l @(bank0a.loc_8c0affd8,pc),r1
extu.b r0,r0
shll2 r0
mov r14,r4
mov.l @r15+,r13
