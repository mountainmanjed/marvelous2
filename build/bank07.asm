...
fmov fr4,fr5
fmov.s fr3,@(r0,r14) 
mov.w @(bank07.loc_8c07f14a,pc),r0
mov.w @(r0,r13),r3
tst r3,r3
bt/s loc_8c07f092
fmov fr4,fr6
mova @(bank07.loc_8c07f15c,pc),r0 
fmov.s @r0,fr8
fmov fr8,fr5
fmov fr8,fr6
fmov fr8,fr7
...
fadd fr7,fr3
fmov.s fr3,@(r0,r14) 
mova @(bank07.loc_8c07f160,pc),r0 
fmov.s @r0,fr7
mov 0x38,r0
fmov.s @(r0,r14),fr3
fadd fr7,fr3
fmov.s fr3,@(r0,r14) 
mov.w @(bank07.loc_8c07f14c,pc),r0
mov.b @(r0,r13),r0
extu.b r0,r0
cmp/eq 0x02,r0 
bf loc_8c07f0b8
...
mov 0x68,r0
fmov.s fr6,@(r0,r14) 
mova @(bank07.loc_8c07f164,pc),r0 
fmov.s @r0,fr3
mov 0x60,r0
mov 0x42,r5
fmov.s fr3,@(r0,r14) 
...
fmov.s fr4,@(r0,r14) 
mov 0x39,r6
mov.w @(bank07.loc_8c07f14e,pc),r0
mov.b r5,@(r0,r14) 
add 0x01,r0
mov.b r5,@(r0,r14) 
add 0x04,r0
...
mov.b r4,@(r0,r14) 
add 0x26,r0
mov.l @(bank07.loc_8c07f168,pc),r5
mov.l r4,@(r0,r14) 
mov.b @(0x02,r14),r0 
mov.l @r5,r3
extu.b r0,r0
...
add 0x01,r2
mov.w r2,@(r0,r3) 
mov.w @(bank07.loc_8c07f150,pc),r0
mov.b r6,@(r0,r13) 
add 0x0B,r0
mov.w r4,@(r0,r13) 
add 0xF2,r0
...
add 0x01,r2
mov.w r2,@(r0,r3) 
mov.l @(bank07.loc_8c07f16c,pc),r3
jsr @r3
mov r14,r4
mov 0x01,r2
mov.l @(bank07.loc_8c07f170,pc),r3
mov.b r2,@r14
mov r14,r4
lds.l @r15+,pr 
mov.l @r15+,r13
...
#align4
loc_8c07f6c0:
mov.w @(bank07.loc_8c07f768,pc),r0
mov.l @r15,r3
mov.b @(r0,r3),r2
tst r2,r2
bf bank07.loc_8c07f6ee
mov.l @r15,r2
mov 0x04,r3
mov.w @(0x1E,r2),r0 
cmp/gt r3,r0
bt bank07.loc_8c07f6ee
...
add 0x01,r1
mov.w r1,@(r0,r2) 
mov.l @(bank07.loc_8c07faa4,pc),r2
jsr @r2
mov r14,r4
lds.l @r15+,pr 
mov.l @(bank07.loc_8c07faa8,pc),r3
mov r14,r4
mov 0x19,r5
mov.l @r15+,r13
jmp @r3
...
loc_8c07fb56:
mov 0x5C,r1
mov.l @(bank07.loc_8c07fbb8,pc),r3
add r14,r1
mov 0x34,r0
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
...
mov r14,r4
lds.l @r15+,pr 
mov.l @(bank07.loc_8c07fbbc,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
#data 0x4F26
