...
loc_8c041f5c:
	...
	jsr @r3
	add 0x34,r4
	mova @(loc_8c04206c,PC),r0
	fmov @r0,fr3
	mov 0x04,r0
	fmov @(r0,r15),fr2
	mova @(loc_8c042070,PC),r0
	fmov @r0,fr1
	mov 0xC0,r4
	fadd fr3,fr2
	fdiv fr1,fr2
...
loc_8c04218c:
	...
	jsr @r3
	add 0x34,r4
	mova @(loc_8c0422bc,PC),r0
	fmov @r0,fr3
	mov 0x04,r0
	fmov @(r0,r15),fr2
	mova @(loc_8c0422c0,PC),r0
	fmov @r0,fr1
	mov 0xC0,r4
	fadd fr3,fr2
	fdiv fr1,fr2
...
loc_8c04ddc2:
	...
	mov 0x01,r0
	mov.b r0,@(0x6,r5)
	mova @(loc_8c04dedc,PC),r0
	fmov @r0,fr3
	mov 0x60,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c04dee0,PC),r0
	fmov @r0,fr3
	mov 0x6c,r0
	fmov fr3,@(r0,r14)
	lds.l @r15+,pr
...
loc_8c04e366:
	mova @(loc_8c04e468,PC),r0
	fmov @r0,fr3
	mov 0x5C,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c04e46c,PC),r0
	fmov @r0,fr3

loc_8c04e372:
	mov 0x68,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c04e470,PC),r0
	fmov @r0,fr3
	mov 0x60,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c04e474,PC),r0
	fmov @r0,fr3
	mov 0x6c,r0
	fmov fr3,@(r0,r14)
...
loc_8c04e824:
	...
	mov.b @(r0,r4),r3
	mova @(loc_8c04e8b4,PC),r0
	fmov @r0,fr5
	mova @(loc_8c04e8b8,PC),r0
	add 0x01,r3
	fmov @r0,fr4
	shll2 r3
	shll r3
...
;Push box Y scale
loc_8c04f81a:
	mova @(loc_8c04f86c,PC),r0 ;8c04f86c
	mov r4,r11
	fmov @r0,fr5
	add 0x08,r11
	mov.w @(0x4,r5),r0
...
;Load Jump Data Start
	...
	mova @(loc_8c04fdf4,PC),r0
	fmov @r0,fr4 ; Load CpsYsclaer (2.142857)


	mova @(loc_8c04fdf8,PC),r0
...
;JumpXV
	mova @(loc_8c04fdfc,PC),r0 ; load CPSscaleXPNT
