...
mov.l @(r0,r4),r3
tst r3,r3
bf bank1a.loc_8c1a0076

loc_8c1a008a:
exts.b r13,r13
tst r13,r13
bf loc_8c1a0094
mov.l @(bank1a.loc_8c1a014c,pc),r2
mov.b r5,@r2
...
tst r3,r3
bt loc_8c1a028e
mov.l @(bank1a.loc_8c1a0358,pc),r2
mov.l @(bank1a.loc_8c1a0354,pc),r3
jsr @r2
mov.l @r3,r4
mov 0x00,r1
mov.b r1,@r14
...
bt loc_8c1a02c6
mov.l @(bank1a.loc_8c1a0358,pc),r2
mov.l @(bank1a.loc_8c1a0360,pc),r3
jsr @r2
mov.l @r3,r4
mov 0x00,r1
mov.b r1,@r14
...
cmp/eq 0x04,r0 
bt loc_8c1a05e8
mov.l @(bank1a.loc_8c1a0660,pc),r3
extu.b r13,r1
mov.w @(bank1a.loc_8c1a065a,pc),r2
shll r1
mov.b @r3,r0
...
loc_8c1a07e6:
mov.l @(bank1a.loc_8c1a0804,pc),r3
mov 0x72,r0
jsr @r3
mov.b @(r0,r12),r4

loc_8c1a07ee:
bsr bank1a.loc_8c1a0862
nop 
bra loc_8c1a0816
nop 
...
or 0x20,r0 
mov.b r0,@r4
mov.l @(bank1a.loc_8c1a0cf0,pc),r4
mov.b @r4,r0
or 0x80,r0 
mov.b r0,@r4
mov.l @(bank1a.loc_8c1a0cf4,pc),r2
mov.l @r2,r3
mov.b @r3,r0
and 0x7F,r0 
mov.b r0,@r3
mov.w @(bank1a.loc_8c1a0cda,pc),r4
bra bank1a.loc_8c1a1296
nop 
...
mov.l @(bank1a.loc_8c1a1d5c,pc),r3
add 0x78,r2
add r7,r2
jsr @r3
mov 0x01,r0
...
mov 0x4C,r0
lds.l @r15+,pr 
mov.l @(bank1a.loc_8c1a1d60,pc),r3
mov.l @(r0,r4),r4
jmp @r3
mov.l @r15+,r14
...
tst r3,r3
bt loc_8c1a1e96
mov.l @(bank1a.loc_8c1a1f00,pc),r3
jsr @r3
nop 
...
tst 0x10,r0 
bf loc_8c1a206c
bsr bank1a.loc_8c1a1b54
mov r14,r4
mov.l @(bank1a.loc_8c1a2150,pc),r3
jsr @r3
mov.l @(0x08,r14),r4
...
bt/s loc_8c1a227c
mov 0x00,r6
mov.w @(bank1a.loc_8c1a2290,pc),r3
...
add r0,r5
mov.w @(0x02,r5),r0 
mov.l @(bank1a.loc_8c1a2400,pc),r1
mov r0,r5
jsr @r1
mov r14,r4
...
muls.w r3,r0
mov.l @(0x0C,r5),r5
mov.l @(bank1a.loc_8c1a2404,pc),r1
add r2,r5
sts macl,r0
exts.w r0,r0
add r0,r5
...
mov 0x01,r5
mov.w r3,@(r0,r13) 
mov.l @(bank1a.loc_8c1a2408,pc),r3
jsr @r3
mov.l @r12,r4
bra loc_8c1a2356
mov 0x01,r4
...
loc_8c1a238c:
mov.l @(loc_8C1A23FC,pc),r12
mov.l @(bank1a.loc_8c1a240c,pc),r0
mov.l @r12,r5
mov.l @(0x04,r5),r5
...
mov r4,r0
nop 
mov.l @(bank1a.loc_8c1a2414,pc),r2
jsr @r2
nop 
...
mov r4,r0
nop 
mov.l @(bank1a.loc_8c1a2418,pc),r3
jsr @r3
nop 
mov.l @r2,r3
add r0,r3
...
#align4
loc_8c1a2400:
#data bank1a.loc_8c1a211a

loc_8c1a2404:
#data bank12.loc_8c129668

loc_8c1a2408:
#data bank1a.loc_8c1a1f04
...
mov.l r1,@r15
mov.l r13,@(0x04,r15) 
mov.l @(bank1a.loc_8c1a2528,pc),r3
jsr @r3
mov r15,r4
mov r0,r5
mov.l @r5,r2
...
tst r2,r2
bt loc_8c1a2574
mov.w @(bank1a.loc_8c1a2628,pc),r0
mov r4,r2
mov 0x00,r3
mov.l r4,@(r0,r4) 
add 0xFC,r0
...
bsr loc_8c1a258e
nop 
mov.l @(bank1a.loc_8c1a2630,pc),r3
mov 0x00,r0
mov.l @r3,r2
mov.l @(0x08,r2),r1
mov 0x58,r2
...
mov 0x00,r12
mov.l r11,@-r15
mov.l @(bank1a.loc_8c1a2630,pc),r11
sts.l pr,@-r15
add 0xEC,r15
mov.l r12,@r15
mov.l @r11,r4
...
loc_8c1a25be:
mov.l @(bank1a.loc_8c1a2634,pc),r0
mov.l @(0x04,r4),r2
...
mul.l r3,r4
mov.l @(bank1a.loc_8c1a263c,pc),r3
sts macl,r4
jsr @r3
mov r4,r1
mov r0,r13
...
mov r15,r4
mov.l r13,@(0x08,r15) 
mov.l @(bank1a.loc_8c1a2640,pc),r3
jsr @r3
add 0x04,r4
bra loc_8c1a264e
mov r0,r4
...
add r3,r13
mov.l @(r0,r14),r5
mov.l @(bank1a.loc_8c1a2770,pc),r3
mov r13,r6
jsr @r3
mov.l @r11,r4
...
mov.l @(r0,r14),r6
add 0xF8,r0
mov.l @(bank1a.loc_8c1a2774,pc),r3
mov.l @(r0,r14),r5
jsr @r3
mov r14,r4
mov.w @(loc_8C1A276A,pc),r0
...
add 0xFC,r0
mov.l r3,@(r0,r14) 
mov.l @(bank1a.loc_8c1a2778,pc),r3
jsr @r3
mov.l @r11,r4
mov 0x00,r0
...
loc_8c1a491e:
mov r2,r5
mov.l @(bank1a.loc_8c1a4960,pc),r3
mov.l r2,@(0x0C,r15) 
shll r5
mov r15,r6
jsr @r3
...
tst r14,r14
bf loc_8c1a4948
mov.l @(bank1a.loc_8c1a4964,pc),r3
mov.l @(0x08,r15),r8
jsr @r3
mov.l @r15,r4
mov.l r0,@r8
...
mov r14,r6
mov.l @(0x04,r15),r5
mov.l @(bank1a.loc_8c1a49e0,pc),r3
shll r5
jsr @r3
mov 0x02,r4
mov r0,r12
tst r12,r12
bf loc_8c1a49d0
mov.l @(bank1a.loc_8c1a49e4,pc),r3
mov.l @r14,r13
jsr @r3
mov r13,r4
mov.l @(bank1a.loc_8c1a49e4,pc),r3
...
mov.l @(0x24,r14),r1
sub r3,r1
mov.l @(bank1a.loc_8c1a4d04,pc),r3
shll2 r1
shll2 r1
shll2 r1
shll r1
...
loc_8c1a4c96:
mov.l @(bank1a.loc_8c1a4d08,pc),r2
jsr @r2
nop 
...
#align4
loc_8c1a7560:
mov.w @(bank1a.loc_8c1a75e2,pc),r5
mov 0x00,r1
...
loc_8c1a7574:
mov.w @(bank1a.loc_8c1a75e2,pc),r2
add r6,r2
add r7,r2
cmp/hs r2,r5
bf loc_8c1a756c
...
nop 
tst r0,r0
bf/s bank1a.loc_8c1a858a
mov.l r0,@r15
bsr bank1a.loc_8c1a898c
mov r13,r4
...
loc_8c1a8788:
mov.l @(bank1a.loc_8c1a8808,pc),r9
exts.w r8,r4
shll2 r4
mov r6,r14
mov r9,r3
...
bf/s loc_8c1a93c0
mov.l @r13,r12
mov.l @(bank1a.loc_8c1a9384,pc),r2
jsr @r2
mov.l @(0x08,r14),r4
tst r0,r0
bf loc_8c1a93c0
...
bf/s loc_8c1a99fc
mov.l @r13,r12
mov.l @(bank1a.loc_8c1a9a30,pc),r2
jsr @r2
mov.l @(0x08,r14),r4
tst r0,r0
bf loc_8c1a99fc
...
sts.l pr,@-r15
add 0xF8,r15
mov.l @(bank1a.loc_8c1aa0dc,pc),r9
mov r5,r13
cmp/pl r13
mov r4,r11
mov.l r6,@r15
...
bf/s loc_8c1a9f74
mov 0x00,r14
mov.l @(bank1a.loc_8c1aa0e0,pc),r12
...
loc_8c1a9fb2:
mov.l @(bank1a.loc_8c1aa0e4,pc),r2
mov r14,r4
mov 0x04,r6
mov.l @r2,r5
jsr @r9
...
mov.b r2,@r3
mov.l @(0x2C,r15),r0
mov.l @(bank1a.loc_8c1aa0e8,pc),r2
mov.b @r0,r0
mov.l @(0x38,r15),r3
jsr @r2
mov r5,r1
...
mov.l r3,@r2
mov.b @r8,r0
mov.l @(bank1a.loc_8c1aa0ec,pc),r3
mov.l @(0x38,r15),r2
jsr @r3
mov r5,r1
mov.l r0,@r2
...
bf/s loc_8c1aa29a
mov.l @r13,r12
mov.l @(bank1a.loc_8c1aa2cc,pc),r2
jsr @r2
mov.l @(0x08,r14),r4
tst r0,r0
bf loc_8c1aa29a
...
loc_8c1aa988:
mov.l @(bank1a.loc_8c1aaa38,pc),r4
...
sts.l pr,@-r15
add 0xF8,r15
mov.l @(bank1a.loc_8c1aaa48,pc),r12
mov.l r5,@r15
jsr @r12
mov.l r6,@(0x04,r15) 
mov.l @r15,r13
...
mov.l @(bank1a.loc_8c1aaa54,pc),r10
add r3,r11
mov.l @(bank1a.loc_8c1aaa4c,pc),r8
cmp/ge r11,r13
mov r13,r14
bt/s loc_8c1aaa0e
shll2 r14
...
loc_8c1aaa0e:
mov.l @(bank1a.loc_8c1aaa28,pc),r4
jsr @r12
nop 
add 0x08,r15
lds.l @r15+,pr 
...
bt loc_8c1aacd2
mov r14,r5
bsr bank1a.loc_8c1aac66
mov r13,r4

loc_8c1aacd2:
mov.w @(bank1a.loc_8c1aad02,pc),r2
add 0x01,r12
add r2,r14
...
loc_8c1aadd6:
mov.w @(bank1a.loc_8c1aae3c,pc),r0
mov.l @(bank1a.loc_8c1aae48,pc),r3
mov.l r1,@(0x14,r2) 
mov.l @r14,r4
mov.l @(r0,r4),r4
jsr @r3
...
tst r0,r0
bf loc_8c1aadf2
mov.l @(bank1a.loc_8c1aae4c,pc),r3
mov 0x01,r5
mov.l @r14,r4
jsr @r3
add 0x04,r4
...
loc_8c1aae92:
mov.l @(bank1a.loc_8c1aaed4,pc),r3
mov.l r11,@(0x0C,r14) 
mov.l r3,@(0x20,r14) 
...
loc_8c1aafbe:
mov.l r14,@-r15
mov.l @(bank1a.loc_8c1ab034,pc),r14
sts.l pr,@-r15
mov.l @r14,r0
mov.b @r0,r0
extu.b r0,r0
cmp/eq 0x26,r0 
bf loc_8c1ab018
mov.l @(bank1a.loc_8c1ab070,pc),r2
jsr @r2
nop 
mov.l @r14,r0
mov.b @r0,r0
...
loc_8c1ab010:
lds.l @r15+,pr 
mov.l @(bank1a.loc_8c1ab074,pc),r3
jmp @r3
mov.l @r15+,r14

loc_8c1ab018:
lds.l @r15+,pr 
mov.l @(bank1a.loc_8c1ab028,pc),r3
mov 0x02,r2
mov.b r2,@r3
rts 
mov.l @r15+,r14
...
mov.l r13,@-r15
sts.l pr,@-r15
mov.l @(bank1a.loc_8c1ab330,pc),r3
...
tst r0,r0
bf loc_8c1ab31c
mov.l @(bank1a.loc_8c1ab33c,pc),r3
...
tst 0x10,r0 
bt loc_8c1ab36a
mov.l @(bank1a.loc_8c1ab3d8,pc),r2
jsr @r2
nop 
exts.b r0,r0
tst r0,r0
...
loc_8c1ab378:
mov.l @(bank1a.loc_8c1ab3dc,pc),r3
jsr @r3
nop 
...
loc_8c1ab944:
mov.l @(bank1a.loc_8c1aba2c,pc),r2
mov 0x01,r3
mov.b r3,@r2
mov.w @(loc_8C1ABA26,pc),r3
mov.l @(loc_8C1ABA30,pc),r1
mov.b r3,@r1
mov.l @(bank1a.loc_8c1aba34,pc),r3
jsr @r3
nop 
...
tst r4,r2
bt loc_8c1ab980
mov.l @(bank1a.loc_8c1aba3c,pc),r2
...
or 0x40,r0 
mov.l @(bank1a.loc_8c1aba44,pc),r3
...
loc_8c1ab980:
mov.l @(bank1a.loc_8c1aba48,pc),r2
jsr @r2
nop 
...
loc_8c1ab98e:
mov.l @(bank1a.loc_8c1aba4c,pc),r3
jsr @r3
nop 
mov.b @(0x05,r14),r0 
extu.b r0,r0
...
mov.l @r3,r5
mov.l @(bank1a.loc_8c1abb44,pc),r2
mov.l @r3,r4
mov.b @(r0,r5),r5
add 0xFF,r0
jsr @r2
...
tst 0x0C,r0 
bt loc_8c1aba8e
mov.l @(bank1a.loc_8c1abb4c,pc),r2
jsr @r2
nop 
...
or 0x80,r0 
mov.b r0,@r3
mov.l @(bank1a.loc_8c1abb54,pc),r2
jsr @r2
mov 0x00,r4
mov.l @(bank1a.loc_8c1abb58,pc),r3
jsr @r3
nop 
...
loc_8c1abab4:
mov.l @(bank1a.loc_8c1abb60,pc),r2
jmp @r2
nop 
...
loc_8c1ac0a0:
mov.l @(bank1a.loc_8c1ac160,pc),r0
extu.b r4,r4
mov r12,r2
add 0x14,r2
mov.b @(r0,r4),r3
...
nop 
add 0x17,r0
mov.l @(bank1a.loc_8c1ac164,pc),r1
mov.b @r0,r0
mov 0xFC,r3
extu.b r0,r0
and 0x30,r0 
...
cmp/eq 0x38,r0 
bf bank1a.loc_8c1ac1b8
mov.l @(bank1a.loc_8c1ac278,pc),r3
jsr @r3
mov.b @r15,r4
exts.b r0,r0
tst r0,r0
bt loc_8c1ac1b0
mov.l @(bank1a.loc_8c1ac27c,pc),r3
jsr @r3
mov.b @r15,r4
bra bank1a.loc_8c1ac1ea
nop 
...
#align4
loc_8c1ac1b8:
mov.l @(bank1a.loc_8c1ac284,pc),r3
mov r15,r5
jsr @r3
mov r11,r4
mov.b @r15,r2
...
mov.l @(bank1a.loc_8c1ac290,pc),r3
and 0x7F,r0 
jsr @r3
mov.b r0,@r2
mov r12,r0
...
loc_8c1ac3e2:
mov.l @(bank1a.loc_8c1ac45c,pc),r2
jmp @r2
mov 0x00,r4
...
loc_8c1ac410:
mov.l @(bank1a.loc_8c1ac42c,pc),r3
mov 0x02,r2
mov.b r2,@r3
...
loc_8c1ac618:
mov.l @(bank1a.loc_8c1ac6e4,pc),r2
jsr @r2
mov 0x00,r4
...
loc_8c1ac646:
add 0x14,r15
mov.l @(bank1a.loc_8c1ac6e8,pc),r3
lds.l @r15+,pr 
mov 0x00,r4
mov.l @r15+,r13
jmp @r3
...
mov.b r0,@r4
mov.b @r4,r0
mov.l @(bank1a.loc_8c1ac7b8,pc),r3
and 0xF7,r0 
jsr @r3
mov.b r0,@r4
exts.b r0,r0
...
mov.l r8,@-r15
sts.l pr,@-r15
mov.l @(bank1a.loc_8c1ad3d8,pc),r10
add 0xF0,r15
jsr @r10
nop 
jsr @r10
...
mov 0x00,r3
mov.l r3,@(0x0C,r15) 
bsr bank1a.loc_8c1ade6a
mov 0x01,r13
mov.l @(bank1a.loc_8c1ad3e0,pc),r14
...
extu.b r13,r9
mov r14,r2
mov.l @(bank1a.loc_8c1ad3e4,pc),r8
cmp/gt r9,r2
mov.l @(bank1a.loc_8c1ad3e8,pc),r12
bt/s loc_8c1ad416
mov r15,r11
...
mov.l @(0x0C,r15),r4
mov 0x10,r5
mov.l @(bank1a.loc_8c1ad3ec,pc),r3
mov r11,r7
mov 0x08,r6
jsr @r3
mov.l @r4,r4
...
bf/s loc_8c1ad3c8
mov.l r2,@(0x0C,r15) 
mov.l @(bank1a.loc_8c1ad3f0,pc),r2
mov r4,r1
jsr @r2
mov 0x08,r0
tst r0,r0
...
loc_8c1ad6fc:
mov.l @(bank1a.loc_8c1ad828,pc),r4
...
cmp/eq 0x01,r0 
bf loc_8c1ad72c
mov.l @(bank1a.loc_8c1ad82c,pc),r3
mov.b @(0x04,r15),r0 
jsr @r3
mov r0,r4
mov.l @(bank1a.loc_8c1ad830,pc),r2
jsr @r2
mov r0,r4
mov.l r0,@-r15
mov.l @(bank1a.loc_8c1ad834,pc),r3
mov.l r3,@-r15
mov.l @(bank1a.loc_8c1ad838,pc),r2
mov r15,r4
jsr @r2
add 0x14,r4
add 0x08,r15
...
jsr @r13
nop 
mov.l @(bank1a.loc_8c1ad83c,pc),r4
jsr @r14
nop 
mov.l @(bank1a.loc_8c1ad840,pc),r3
jsr @r3
nop 
mov 0x03,r6
mov 0x0A,r5
...
loc_8c1ad76c:
mov.l @(bank1a.loc_8c1ad844,pc),r4
jsr @r14
nop 
mov.l @(bank1a.loc_8c1ad848,pc),r3
jsr @r3
nop 
mov 0x04,r6
mov 0x10,r5
...
loc_8c1ad7b2:
mov.l @(bank1a.loc_8c1ad84c,pc),r4
jsr @r14
nop 
mov.l @(bank1a.loc_8c1ad850,pc),r2
jsr @r2
nop 
mov 0x04,r6
mov 0x0A,r5
...
jsr @r14
mov r12,r4
mov.l @(bank1a.loc_8c1ad854,pc),r4
jsr @r14
nop 
jsr @r13
nop 
mov.l @(bank1a.loc_8c1ad858,pc),r4
jsr @r14
nop 
mov.l @(bank1a.loc_8c1ad85c,pc),r3
jsr @r3
nop 
mov 0x03,r6
mov 0x0A,r5
...
jsr @r14
mov r12,r4
mov.l @(bank1a.loc_8c1ad860,pc),r4
jsr @r14
nop 
jsr @r13
nop 
mov.l @(bank1a.loc_8c1ad864,pc),r4
jsr @r14
nop 
mov.l @(bank1a.loc_8c1ad868,pc),r2
jsr @r2
nop 
mov 0x03,r6
mov 0x0A,r5
...
loc_8c1adc78:
mov.l @(bank1a.loc_8c1add64,pc),r4
jsr @r14
nop 
...
#align4
loc_8c1adcd0:
mov.l @(bank1a.loc_8c1add7c,pc),r1
mov 0x02,r0
mov.b r0,@r1
...
#align4
loc_8c1add4c:
mov.l @(bank1a.loc_8c1add80,pc),r4
mov.l @r4,r0
mov.b @r0,r0
extu.b r0,r0
cmp/eq 0x3B,r0 
...
bsr bank1a.loc_8c1ade6a
nop 
mov.l @(bank1a.loc_8c1ade84,pc),r1
mov.l @r1,r3
mov.b @r3,r2
bsr bank1a.loc_8c1ade6a
mov.b r2,@r15
...
loc_8c1ade5c:
mov.l @(bank1a.loc_8c1ade88,pc),r3
mov.b @r3,r2
extu.b r2,r2
cmp/eq r2,r5
bf bank1a.loc_8c1ade3c
...
loc_8c1ae02a:
mov.l @(bank1a.loc_8c1ae17c,pc),r14
mov 0x02,r8
mov.b @(0x0B,r4),r0 
extu.b r0,r0
tst r8,r0
bt/s bank1a.loc_8c1ae0ce
mov 0x00,r9
mov.b @(0x07,r13),r0 
extu.b r0,r0
tst r10,r0
...
loc_8c1ae064:
mov.l @(bank1a.loc_8c1ae188,pc),r2
jsr @r2
nop 
exts.b r0,r0
tst r0,r0
bf bank1a.loc_8c1ae080
...
extu.b r4,r0
mov.l @(bank1a.loc_8c1ae3e8,pc),r10
...
and 0xBF,r0 
mov.b r0,@(0x06,r14) 
mov.l @(bank1a.loc_8c1ae3f8,pc),r2
mov.l @(loc_8C1AE3F4,pc),r3
mov.b @(0x03,r12),r0 
jsr @r2
mov.b r0,@r3
mov.l @(bank1a.loc_8c1ae3fc,pc),r1
jsr @r1
nop 
mov.l @(bank1a.loc_8c1ae400,pc),r2
jsr @r2
nop 
jsr @r10
nop 
...
mov.l @(bank1a.loc_8c1ae418,pc),r1
...
mov.l r10,@r15
mov.b @r3,r2
mov.l @(bank1a.loc_8c1ae694,pc),r6
extu.b r2,r2
tst r5,r2
bf/s loc_8c1ae686
mov 0x20,r11
...
tst r11,r2
bt loc_8c1ae6f6
mov.l @(bank1a.loc_8c1ae86c,pc),r1
jsr @r1
nop 
mov.b r0,@(0x04,r15) 
extu.b r0,r0
...
mov.b r3,@-r2
mov.b @(0x04,r15),r0 
bsr bank1a.loc_8c1aee58
mov r0,r4
mov.l r0,@-r15
mov.l @(bank1a.loc_8c1ae870,pc),r2
mov.l r2,@-r15
mov.l @(bank1a.loc_8c1ae874,pc),r3
jsr @r3
mov r8,r4
mov.l @(bank1a.loc_8c1ae878,pc),r2
mov r8,r1
add 0x08,r15
jsr @r2
mov.l @r15,r0
mov.l @(bank1a.loc_8c1ae87c,pc),r3
jsr @r3
mov r8,r4
mov.l @r15,r2
add r0,r2
...
loc_8c1aed70:
mov.l @(bank1a.loc_8c1aedfc,pc),r3
jsr @r3
nop 
tst r14,r14
bf loc_8c1aed82
mov.l @(bank1a.loc_8c1aee00,pc),r0
extu.b r13,r14
shll2 r14
mov.l @(r0,r14),r14
...
loc_8c1aeda6:
mov.l @(bank1a.loc_8c1aee04,pc),r3
mov 0x0A,r5
mov r15,r7
jsr @r3
extu.b r13,r4
bsr bank1a.loc_8c1aecdc
mov r15,r4
mov.b @(0x03,r11),r0 
bsr bank1a.loc_8c1aec3a
mov r0,r4
bra loc_8c1aedd4
nop 
...
mov r14,r0
nop 
mov.l @(bank1a.loc_8c1af288,pc),r3
jsr @r3
nop 
mov r0,r6
exts.b r6,r2
...
loc_8c1af398:
mov.b @(0x04,r15),r0 
mov.l @(bank1a.loc_8c1af434,pc),r5
mov r0,r4
mov.b @(0x0E,r14),r0 
extu.b r0,r0
tst r12,r0
...
tst r10,r2
bt loc_8c1af4ba
mov.l @(bank1a.loc_8c1af570,pc),r2
jsr @r2
nop 
mov.l @(bank1a.loc_8c1af574,pc),r3
extu.w r0,r1
jsr @r3
mov 0x32,r0
mov r0,r2
...
loc_8c1af8ba:
mov.l @(bank1a.loc_8c1af9c0,pc),r2
jsr @r2
nop 
...
mov.l @r3,r5
mov.l @(bank1a.loc_8c1af9cc,pc),r2
mov.l @r3,r4
mov.b @(r0,r5),r5
add 0xFF,r0
jsr @r2
...
or 0x80,r0 
mov.b r0,@(0x09,r14) 
mov.l @(bank1a.loc_8c1af9d0,pc),r3
jsr @r3
mov 0x00,r4
mov.l @(bank1a.loc_8c1af9d4,pc),r2
jsr @r2
nop 
mov.b @(0x04,r14),r0 
and 0xEF,r0 
...
mov.l @(bank1a.loc_8c1afb60,pc),r1
mov.l @(loc_8C1AFB5C,pc),r2
mov.b @r3,r5
jsr @r1
mov.b @r2,r4
mov.l @(bank1a.loc_8c1afb64,pc),r3
jsr @r3
mov 0x01,r4
mov.b @(0x09,r14),r0 
and 0x7F,r0 
...
mov 0x10,r6
mov.l r13,@-r15
mov.l @(bank1a.loc_8c1afb68,pc),r2
mov r13,r7
jsr @r2
mov 0x07,r4
mov.l @(bank1a.loc_8c1afb6c,pc),r3
jsr @r3
add 0x0C,r15
mov.l @(bank1a.loc_8c1afb70,pc),r2
jsr @r2
mov r13,r4
mov.b @(0x03,r14),r0 
and 0x17,r0 
...
tst 0x20,r0 
bt loc_8c1afafe
mov.l @(bank1a.loc_8c1afb78,pc),r2
jsr @r2
mov 0x01,r4
...
tst 0x40,r0 
bt loc_8c1afb12
mov.l @(bank1a.loc_8c1afb7c,pc),r2
jsr @r2
mov 0x01,r4

loc_8c1afb12:
mov.l @(bank1a.loc_8c1afb80,pc),r3
jsr @r3
mov 0x00,r4
mov.l @(bank1a.loc_8c1afb84,pc),r2
jsr @r2
mov 0x01,r4
mov.l @(loc_8C1AFB88,pc),r3
mov.w @(loc_8C1AFB48,pc),r0
mov.l @r3,r5
mov.l @(bank1a.loc_8c1afb90,pc),r2
mov.l @(loc_8C1AFB8C,pc),r4
mov.w @(r0,r5),r5
jsr @r2
extu.w r5,r5
mov.l @(bank1a.loc_8c1afb94,pc),r3
jsr @r3
nop 
mov.b @(0x0B,r14),r0 
and 0xDF,r0 
...
mov.l r0,@-r15
mov r0,r3
mov.l @(bank1a.loc_8c1b0020,pc),r3
mov.l @(bank1a.loc_8c1b0024,pc),r2
mov.l @(bank1a.loc_8c1b0028,pc),r1
mov.b @r2,r5
mov.b @r3,r6
jsr @r1
mov 0x07,r4
