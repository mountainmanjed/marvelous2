...
#align4
loc_8c0d0388:
mov.w @(bank0d.loc_8c0d0408,pc),r2
mov.l @(bank0d.loc_8c0d0418,pc),r1
add r13,r2
mov.b @r2,r2
add 0xFF,r2
mov r2,r3
...
lds r3,fpul 
mov 0x38,r1
mov.w @(bank0d.loc_8c0d0408,pc),r3
add r14,r1
mov.l @(bank0d.loc_8c0d0418,pc),r4
add r13,r3
float fpul,fr3
fmov.s @r8,fr2
fadd fr3,fr2
...
mov r0,r3
lds r3,fpul 
mov.w @(bank0d.loc_8c0d0408,pc),r0
float fpul,fr3
fadd fr3,fr2
fmov.s fr2,@r1
mov.b @(r0,r13),r3
...
loc_8c0d050c:
mov 0x21,r3
mov.l @(bank0d.loc_8c0d0580,pc),r6
add r5,r3
mov 0x34,r0
fmov.s @(r0,r4),fr3
fmov.s fr3,@(r0,r5) 
...
add r2,r3
add r3,r6
mov.w @(bank0d.loc_8c0d0572,pc),r0
mov.w @r6,r3
mov.w @(r0,r4),r2
lds r3,fpul 
tst r2,r2
...
mov r5,r0
nop 
mov.l @(bank0d.loc_8c0d06cc,pc),r3
mov 0x03,r5
mov.b r0,@(0x04,r15) 
mov.b r6,@r15
mov 0x00,r6
...
bt/s loc_8c0d064c
mov r0,r4
mov.l @(bank0d.loc_8c0d06d0,pc),r3
mov r14,r2
mov.w @(loc_8C0D06BC,pc),r1
mov.w @(loc_8C0D06BC,pc),r0
mov.l r3,@(0x10,r4) 
add r4,r1
mov.l @(bank0d.loc_8c0d06d4,pc),r3
add r0,r2
mov.l r14,@(0x18,r4) 
jsr @r3
add 0xE4,r0
...
mov.b r2,@(r0,r4) 
mov.l @(0x18,r4),r2
mov.l @(bank0d.loc_8c0d06d8,pc),r3
add 0x50,r2
jsr @r3
mov 0x0C,r0
mov.l @(0x18,r4),r1
...
mov 0x00,r3
mov.b @r15,r0
mov.w @(bank0d.loc_8c0d06c6,pc),r5
mov.b r0,@(0x05,r4) 
mov.w @(loc_8C0D06BE,pc),r0
add r4,r5
mov.b r3,@(r0,r4) 
...
#align4
loc_8c0d09cc:
mov.w @(bank0d.loc_8c0d0ac2,pc),r0
mov 0x01,r2
mov.w r2,@(r0,r14) 
...
loc_8c0d1180:
mov.l @(bank0d.loc_8c0d1294,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
loc_8c0d134a:
mov 0x34,r0
mov.l @(bank0d.loc_8c0d13b8,pc),r6
mov 0x20,r3
fmov.s @(r0,r4),fr3
add r5,r3
fmov.s fr3,@(r0,r5) 
...
#align4
loc_8c0d1d0c:
mov.w @(bank0d.loc_8c0d1d3a,pc),r0
mov.l @(0x18,r14),r4
mov.b @(r0,r4),r0
extu.b r0,r0
cmp/eq 0x15,r0 
...
loc_8c0d1d62:
mov.l @(bank0d.loc_8c0d1e84,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.b @(0x05,r4),r0 
tst r0,r0
bt bank0d.loc_8c0d21de

loc_8c0d21ce:
lds.l @r15+,pr 
mov r14,r4
bra bank0d.loc_8c0d242c
mov.l @r15+,r14
...
loc_8c0d231a:
mov.l @(bank0d.loc_8c0d2358,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt bank0d.loc_8c0d235c
mov 0x00,r0
bra bank0d.loc_8c0d235c
mov.b r0,@(0x04,r14) 
...
mov.b @(r0,r13),r2
mov.l @(bank0d.loc_8c0d26c8,pc),r0
extu.b r2,r2
shll r2
mov.w @(r0,r2),r3
...
loc_8c0d289c:
mov.l @(bank0d.loc_8c0d28d4,pc),r3
mov 0x1B,r5
jsr @r3
mov r14,r4
...
exts.b r0,r0
cmp/pz r0
bt bank0d.loc_8c0d2f5a
bsr bank0d.loc_8c0d3010
mov r14,r4
...
loc_8c0d33ce:
mov.l @(bank0d.loc_8c0d341c,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.l @(0x18,r14),r3
mov.b r2,@(r0,r3) 
mov.l @(bank0d.loc_8c0d3a44,pc),r3
jsr @r3
mov r14,r4
mov.w @(bank0d.loc_8c0d3a22,pc),r0
mov 0x01,r2
mov.b r2,@(r0,r14) 
...
loc_8c0d3a6a:
mov.l @(bank0d.loc_8c0d3b78,pc),r3
mov 0x00,r13
jsr @r3
mov r14,r4
exts.b r0,r0
...
mov.l @(0x18,r14),r3
mov.b r13,@(r0,r3) 
mov.l @(bank0d.loc_8c0d3b7c,pc),r3
jsr @r3
mov r14,r4
mov.w @(loc_8C0D3B6E,pc),r0
mov 0x01,r2
...
loc_8c0d3d52:
fmov.s @r8,fr2
mov.l @(bank0d.loc_8c0d3d98,pc),r3
fadd fr3,fr2
fmov.s fr2,@r8
jsr @r3
mov r14,r4
...
#align4
loc_8c0d3f9c:
mov.l @(bank0d.loc_8c0d4014,pc),r3
...
mov 0x1B,r5
mov.l @(bank0d.loc_8c0d4028,pc),r3
mov 0x11,r6
fmov.s fr2,@(r0,r14) 
...
jsr @r3
mov r14,r4
mov.l @(bank0d.loc_8c0d402c,pc),r2
mov 0x2D,r5
jsr @r2
mov r14,r4
mov 0x03,r0
...
mov.b r0,@(0x04,r14) 
mov 0x00,r3
mov.w @(bank0d.loc_8c0d4186,pc),r0
mov.b r3,@(r0,r14) 

loc_8c0d416a:
mov.l @(bank0d.loc_8c0d41ac,pc),r3
jsr @r3
nop 
...
tst r2,r2
bt loc_8c0d41b0
mova @(bank0d.loc_8c0d41a4,pc),r0 
bra loc_8c0d41b2
fmov.s @r0,fr3
#data 0x0130
#data 0x1700
...
loc_8c0d42f6:
mov.l @(bank0d.loc_8c0d43d8,pc),r3
jsr @r3
mov r14,r4
lds.l @r15+,pr 
mov r14,r4
...
add 0x34,r1
mov.b @(r0,r3),r2
mov.l @(bank0d.loc_8c0d43dc,pc),r3
mov.b r2,@(r0,r14) 
mov.l @(0x18,r14),r2
add 0x34,r2
jsr @r3
...
mov 0x1B,r5
mov.l @(0x18,r14),r7
mov.l @(bank0d.loc_8c0d43e0,pc),r2
add r3,r7
mov.b @(0x01,r7),r0 
mov r0,r7
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0d.loc_8c0d454c,pc),r2
jmp @r2
mov.l @r15+,r14
...
mov 0x01,r2
mov.b r3,@(r0,r14) 
mov.w @(bank0d.loc_8c0d4534,pc),r0
mov.b r2,@(r0,r14) 
...
mov.b @(r0,r14),r7
mov 0x1B,r5
mov.w @(bank0d.loc_8c0d453a,pc),r0
extu.b r7,r7
mov.b @(r0,r14),r6
add 0xFF,r7
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0d.loc_8c0d4550,pc),r3
jmp @r3
mov.l @r15+,r14
...
mov.b r0,@(0x04,r14) 
mov 0x00,r3
mov.w @(bank0d.loc_8c0d4746,pc),r0
mov.b r3,@(r0,r14) 

loc_8c0d4710:
mov.l @(bank0d.loc_8c0d4750,pc),r3
jsr @r3
nop 
...
mov.b r0,@(0x04,r4) 
mov 0x00,r2
mov.w @(bank0d.loc_8c0d490c,pc),r0
mov.b r2,@(r0,r4) 

loc_8c0d48f2:
mov.l @(bank0d.loc_8c0d4914,pc),r3
jmp @r3
lds.l @r15+,pr 
...
loc_8c0d4b7a:
mov.l @(bank0d.loc_8c0d4bb0,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.b r0,@(0x04,r14) 
mov 0x00,r3
mov.w @(bank0d.loc_8c0d4ba8,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c0d4c72:
mov.l @(bank0d.loc_8c0d4d38,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
mov.b r0,@(0x04,r14) 
mov 0x00,r3
mov.w @(bank0d.loc_8c0d4d22,pc),r0
mov.b r3,@(r0,r14) 

loc_8c0d4c88:
mov.l @(loc_8C0D4D3C,pc),r1
mov.w @(bank0d.loc_8c0d4d28,pc),r0
lds r1,fpul 
fmov.s @(r0,r14),fr2
fsts fpul,fr3
fsub fr3,fr2
...
mov 0x02,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0d.loc_8c0d4df0,pc),r0
mov.b r12,@(r0,r14) 
...
mov.b r3,@(r0,r14) 
mov.b @(0x01,r7),r0 
mov.l @(bank0d.loc_8c0d4df8,pc),r3
mov r0,r7
mov.w @(loc_8C0D4DEC,pc),r0
add 0xFF,r7
mov.b @(r0,r14),r6
...
fmov.s @r8,fr2
mov 0x1B,r5
mov.l @(bank0d.loc_8c0d50d0,pc),r3
mov 0x06,r6
fadd fr3,fr2
fmov.s fr2,@r8
jsr @r3
...
mov r14,r4
mov.l @r15+,r13
bra bank0d.loc_8c0d5544
mov.l @r15+,r14

loc_8c0d4fdc:
mov.l @(bank0d.loc_8c0d50dc,pc),r2
jsr @r2
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt loc_8c0d4ff2
mov.l @(bank0d.loc_8c0d50e0,pc),r2
jsr @r2
mov r13,r4
mov 0x02,r0
mov.b r0,@(0x04,r14) 
...
bf loc_8c0d57c0
mov r13,r2
mov.l @(bank0d.loc_8c0d5830,pc),r3
mov r14,r1
add 0x34,r2
add 0x34,r1
jsr @r3
...
mov.b @(0x01,r2),r0 
tst r0,r0
bt bank0d.loc_8c0d5802
mov.w @(loc_8C0D5826,pc),r0
add r13,r0
mov.b @(0x01,r0),r0 
cmp/eq 0x09,r0 
bf bank0d.loc_8c0d57e6
...
#align4
loc_8c0d5ae8:
mov.w @(bank0d.loc_8c0d5bec,pc),r2
add r13,r2
mov.b @(0x01,r2),r0 
tst r0,r0
bt loc_8c0d5b12
mov.w @(bank0d.loc_8c0d5bec,pc),r7
mov 0x1B,r5
mov.l @(bank0d.loc_8c0d5bfc,pc),r3
add r13,r7
mov.b @(0x01,r7),r0 
mov r0,r7
...
loc_8c0d5c56:
mov.l @(bank0d.loc_8c0d5d04,pc),r2
lds r2,fpul 
fsts fpul,fr3
...
loc_8c0d5cf6:
lds.l @r15+,pr 
mov.l @(bank0d.loc_8c0d5d38,pc),r3
mov 0x1B,r5
jmp @r3
mov.l @r15+,r8
...
loc_8c0d621c:
mov 0x64,r1
mov.w @(bank0d.loc_8c0d624e,pc),r0
add r14,r1
fmov.s @(r0,r14),fr2
fmov.s @r1,fr3
fadd fr3,fr2
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0d.loc_8c0d68f4,pc),r3
jsr @r3
mov r4,r14
exts.b r0,r0
cmp/pz r0
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0d.loc_8c0d68d8,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c0d6894:
mov.w @(0x1C,r4),r0 
mov.w @(bank0d.loc_8c0d68d4,pc),r1
mov r0,r3
lds r3,fpul 
add r4,r1
fldi0 fr2
fmov.s @r1,fr3
float fpul,fr1
mov.w @(bank0d.loc_8c0d68d4,pc),r2
fneg fr3
fadd fr2,fr3
add r4,r2
fdiv fr1,fr3
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0d.loc_8c0d6b9c,pc),r3
jsr @r3
mov r4,r14
exts.b r0,r0
cmp/pz r0
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0d.loc_8c0d6b76,pc),r0
mov.b r3,@(r0,r14) 
...
loc_8c0d7352:
mov.l @(bank0d.loc_8c0d7478,pc),r3
mov 0x04,r5
mov 0x00,r6
jsr @r3
mov r6,r4
...
bt/s loc_8c0d7384
mov r0,r4
mov.l @(bank0d.loc_8c0d747c,pc),r3
mov r4,r1
add 0x5C,r1
mov.l r3,@(0x10,r4) 
mov.l @r15,r2
mov.l @(bank0d.loc_8c0d7480,pc),r3
mov.l r2,@(0x18,r4) 
mov.l @(0x08,r15),r2
jsr @r3
mov 0x0C,r0
...
mov 0x01,r9
sts.l pr,@-r15
mov.l @(bank0d.loc_8c0d7b7c,pc),r8
mov r4,r13
...
mov r0,r4
mov 0x20,r0
mov.l @(bank0d.loc_8c0d7b80,pc),r2
mov.l r2,@(0x10,r4) 
mov.b r9,@(r0,r4) 
mov 0x26,r0
mov.l r12,@(0x18,r4) 
...
loc_8c0d7e6a:
bsr bank0d.loc_8c0d7bd0
mov r14,r4
mov.w @(bank0d.loc_8c0d7eae,pc),r1
add r14,r1
mov.b r0,@r1
mov.w @(bank0d.loc_8c0d7eae,pc),r0
mov.b @(r0,r14),r3
tst r3,r3
bt loc_8c0d7e86
mov.l @(bank0d.loc_8c0d7ec0,pc),r3
mov 0x1B,r5
mov r13,r6
jsr @r3
mov r14,r4
...
cmp/pz r2
bt loc_8c0d8a7c
mov.w @(bank0d.loc_8c0d8ae2,pc),r0
mov 0x01,r2
mov.b r2,@(r0,r14) 
...
#align4
loc_8c0d8b84:
mov.w @(bank0d.loc_8c0d8bf6,pc),r0
mov 0x00,r2
mov.b r2,@(r0,r14) 
mov 0x22,r0
mov.b @(r0,r14),r3
...
mov.w @(bank0d.loc_8c0d93ac,pc),r3
mov.w @(r0,r4),r2
add 0xFF,r2
mov.w r2,@(r0,r4) 
extu.w r2,r2
...
loc_8c0d937a:
mov.l r14,@-r15
mov.w @(bank0d.loc_8c0d93b6,pc),r14
mov.l r13,@-r15
add r4,r14
sts.l pr,@-r15
mov.b @(0x04,r14),r0 
...
mov.l @(0x18,r14),r13
mov.l @(bank0d.loc_8c0d9504,pc),r3
jsr @r3
add r13,r2
...
add 0x50,r2
mov.b r3,@(r0,r14) 
mov.l @(bank0d.loc_8c0d9508,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov.b @(r0,r13),r2
...
mov 0x24,r0
mov.b r3,@(r0,r14) 
mov.l @(bank0d.loc_8c0d950c,pc),r3
jsr @r3
mov r14,r4
mov.l @(bank0d.loc_8c0d9510,pc),r2
jsr @r2
mov r14,r4
mov 0x04,r0
mov.w r0,@(0x1E,r14) 
...
loc_8c0d9986:
mov.w @(bank0d.loc_8c0d9a8c,pc),r0
mov 0x00,r1
mov.w r1,@(r0,r14) 
...
cmp/eq r3,r0
bt loc_8c0d99a2
mov.l @(bank0d.loc_8c0d9a90,pc),r3
mov 0x19,r5
mov 0x03,r6
jsr @r3
mov r14,r4
...
loc_8c0d9ada:
mov.w @(bank0d.loc_8c0d9be2,pc),r0
mov 0x00,r1
mov.w r1,@(r0,r14) 
...
cmp/eq r3,r0
bt loc_8c0d9af6
mov.l @(bank0d.loc_8c0d9be8,pc),r3
mov 0x19,r5
mov 0x0A,r6
jsr @r3
mov r14,r4
...
fldi0 fr3
fmov.s fr3,@(r0,r14) 
mov.w @(bank0d.loc_8c0d9cfa,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt loc_8c0d9c7a
mov 0x5C,r0
...
cmp/eq r3,r0
bt loc_8c0d9c90
mov.l @(bank0d.loc_8c0d9d0c,pc),r3
mov 0x19,r5
mov 0x04,r6
jsr @r3
mov r14,r4
...
loc_8c0d9d46:
mov.w @(bank0d.loc_8c0d9e06,pc),r0
mov 0x01,r2
mov.w r2,@(r0,r14) 
...
cmp/eq r3,r0
bt loc_8c0d9d70
mov.l @(bank0d.loc_8c0d9e14,pc),r3
mov 0x19,r5
mov 0x05,r6
jsr @r3
mov r14,r4
...
#align4
loc_8c0d9e24:
mov.w @(bank0d.loc_8c0d9f40,pc),r0
mov.w r4,@(r0,r14) 
...
loc_8c0d9e50:
mov.l @(bank0d.loc_8c0d9f48,pc),r3
mov 0x19,r5
jsr @r3
mov r14,r4
lds.l @r15+,pr 
...
loc_8c0d9fd2:
mov.l @(bank0d.loc_8c0da09c,pc),r3
jsr @r3
mov r14,r4
mov.w @(loc_8C0DA08E,pc),r0
mov.b @(r0,r14),r2
tst r2,r2
bt loc_8c0d9fec
mov.w @(bank0d.loc_8c0da092,pc),r0
mov.w @(r0,r13),r3
mov.w r3,@(r0,r14) 
mov 0x34,r0
fmov.s @(r0,r13),fr3
...
mov r4,r14
mov 0x60,r1
mov.l @(bank0d.loc_8c0da468,pc),r3
add r14,r1
mov 0x38,r0
sts.l pr,@-r15
fmov.s @r1,fr3
...
add 0x01,r0
mov.b r0,@(0x07,r14) 
mov.w @(bank0d.loc_8c0da452,pc),r0
mov.b r4,@r14
mov.b r4,@(r0,r14) 
...
loc_8c0da63e:
mov.l @(bank0d.loc_8c0da694,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf loc_8c0da65c
...
add r14,r2
mov.b @(0x07,r14),r0 
mov.l @(bank0d.loc_8c0da7b0,pc),r1
mov.b r0,@r2
extu.b r12,r0
shll r0
mov.b @(r0,r1),r0
...
add 0x08,r15
lds.l @r15+,pr 
mov.l @(bank0d.loc_8c0dae1c,pc),r3
mov.l @r15+,r13
jmp @r3
mov.l @r15+,r14
...
mov r5,r0
nop 
mov.l @(bank0d.loc_8c0dafa4,pc),r3
mov 0x03,r5
mov.b r0,@(0x04,r15) 
mov 0x02,r6
jsr @r3
...
bt/s loc_8c0daed2
mov r0,r4
mov.l @(bank0d.loc_8c0dafa8,pc),r3
mov 0x20,r1
add r4,r1
mov.l r3,@(0x10,r4) 
mov.b @(0x04,r15),r0 
...
loc_8c0db652:
mov 0x38,r0
mov.l @(bank0d.loc_8c0db6a0,pc),r3
fmov.s @(r0,r13),fr2
...
loc_8c0db744:
mov.l @(bank0d.loc_8c0db7fc,pc),r3
jsr @r3
nop 
mov.l @(bank0d.loc_8c0db800,pc),r2
mov 0x1B,r5
mov 0x10,r6
jsr @r2
mov r14,r4
...
tst r0,r0
bt loc_8c0db776
mov.l @(bank0d.loc_8c0db804,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf loc_8c0db788
...
add 0x01,r0
mov.b r0,@(0x04,r14) 
mov.w @(bank0d.loc_8c0db7ea,pc),r0
mov.b r3,@(r0,r14) 
lds.l @r15+,pr 
rts 
mov.l @r15+,r14
...
loc_8c0db788:
mov 0x5C,r1
mov.l @(bank0d.loc_8c0db808,pc),r3
add r14,r1
mov r14,r4
mov 0x34,r0
fmov.s @r1,fr3
...
mov 0x13,r6
mov.l @(bank0d.loc_8c0dbaa0,pc),r3
fmov.s @(r0,r4),fr2
mov 0x38,r0
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
...
jsr @r3
mov r14,r4
mov.l @(bank0d.loc_8c0dbaa4,pc),r3
mov 0x01,r2
mov.b r2,@r14
jsr @r3
mov r14,r4
...
loc_8c0dba44:
mov.l @(bank0d.loc_8c0dbaa8,pc),r3
jmp @r3
nop 
...
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
mova @(bank0d.loc_8c0dbe14,pc),r0 
fmov.s @r0,fr2
...
mov 0x14,r6
mov.l @(bank0d.loc_8c0dbe1c,pc),r3
fmov.s @(r0,r4),fr2
mov 0x38,r0
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
...
jsr @r3
mov r14,r4
mov.l @(bank0d.loc_8c0dbe20,pc),r3
mov 0x01,r2
mov.b r2,@r14
jsr @r3
mov r14,r4
...
loc_8c0dbd7a:
mov.l @(bank0d.loc_8c0dbe24,pc),r3
jmp @r3
nop 
...
loc_8c0dc456:
mova @(bank0d.loc_8c0dc4b4,pc),r0 
fmov.s @r0,fr3

loc_8c0dc45a:
mov 0x34,r0
fmov.s @(r0,r13),fr4
mov.w @(bank0d.loc_8c0dc4b2,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf/s loc_8c0dc470
fadd fr3,fr4
...
mov.b @(0x07,r14),r0 
mov 0x19,r6
mov.l @(bank0d.loc_8c0dc4bc,pc),r3
mov r6,r5
add 0x01,r0
mov r14,r4
mov.b r0,@(0x07,r14) 
...
loc_8c0dc672:
mova @(bank0d.loc_8c0dc6b8,pc),r0 
fmov.s @r0,fr3

loc_8c0dc676:
mov 0x34,r0
fmov.s @(r0,r13),fr4
mov.w @(bank0d.loc_8c0dc6b4,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf/s loc_8c0dc68c
fadd fr3,fr4
...
mov 0x34,r0
fmov.s @(r0,r13),fr4
mov.w @(bank0d.loc_8c0dc7c0,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf/s loc_8c0dc752
fadd fr3,fr4
...
mov.b @(0x07,r14),r0 
mov 0x14,r6
mov.l @(bank0d.loc_8c0dc7d4,pc),r3
mov 0x19,r5
add 0x01,r0
mov r14,r4
mov.b r0,@(0x07,r14) 
...
mov 0x34,r0
fmov.s @(r0,r13),fr4
mov.w @(bank0d.loc_8c0dc9fa,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf/s loc_8c0dc99e
fadd fr3,fr4
...
mov.b @(0x07,r14),r0 
mov r13,r2
mov.l @(bank0d.loc_8c0dca1c,pc),r3
mov r14,r1
add 0x01,r0
add 0x34,r2
mov.b r0,@(0x07,r14) 
...
mov.w r0,@(0x1C,r13) 
lds.l @r15+,pr 
mov.l @(bank0d.loc_8c0dca04,pc),r2
mov.l @r15+,r13
jmp @r2
mov.l @r15+,r14
...
fmov.s @r0,fr3
mov 0x38,r0
mov.l @(bank0d.loc_8c0dcdd8,pc),r3
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
mov 0x5C,r0
fmov.s fr4,@(r0,r14) 
...
jsr @r3
mov r14,r4
mov.l @(bank0d.loc_8c0dcddc,pc),r12
mov r14,r5
mov 0x35,r6
jsr @r12
mov r14,r4
...
jsr @r12
mov r14,r4
mov.l @(bank0d.loc_8c0dcde0,pc),r3
mov 0x01,r2
mov.b r2,@r14
jsr @r3
mov r14,r4
...
mov 0x34,r0
fmov.s @(r0,r13),fr4
mov.w @(bank0d.loc_8c0dd034,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf/s loc_8c0dcfcc
fadd fr3,fr4
...
mov.b @(0x07,r14),r0 
mov r14,r4
mov.l @(bank0d.loc_8c0dd040,pc),r3
mov 0x1D,r6
add 0x01,r0
mov.b r0,@(0x07,r14) 
mov 0x34,r0
...
loc_8c0dd1b8:
mov 0x24,r0
mov.l @(bank0d.loc_8c0dd2bc,pc),r5
mov.b @(r0,r13),r3
mov r15,r4
mov.b r3,@(r0,r14) 
...
fmul fr1,fr3
fmov.s fr3,@(r0,r4) 
mov.w @(bank0d.loc_8c0dd2b6,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0dd202
mov 0x34,r0
...
mov 0x04,r0
fmov.s fr3,@(r0,r4) 
mov.w @(bank0d.loc_8c0dd430,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0dd3b4
mov 0x34,r0
...
loc_8c0dd778:
mov.l r14,@-r15
mov.w @(bank0d.loc_8c0dd7aa,pc),r14
mov.l r13,@-r15
add r4,r14
sts.l pr,@-r15
mov.b @(0x04,r14),r0 
...
#align4
loc_8c0dd810:
mov.l @(bank0d.loc_8c0dd910,pc),r3
jsr @r3
mov r14,r4
...
tst r3,r3
bt loc_8c0dd828
mov.w @(bank0d.loc_8c0dd8fa,pc),r3
mov.l @(0x18,r14),r0
add r3,r0
mov.b @(0x01,r0),r0 
mov.w r0,@(0x1C,r14) 
...
fmov.s @(r0,r3),fr3
fmov.s fr3,@(r0,r4) 
mov.w @(bank0d.loc_8c0ddd66,pc),r0
mov.l @(0x18,r4),r3
mov.w @(r0,r3),r2
tst r2,r2
bt loc_8c0ddcc0
...
mov 0x34,r0
add r0,r3
mov.l @(bank0d.loc_8c0ddd7c,pc),r0
mov.l r3,@-r15
mov 0x20,r3
add r4,r3
mov.b @r3,r3
...
mov.b @(0x04,r4),r0 
add 0x01,r0
bra bank0d.loc_8c0de048
mov.b r0,@(0x04,r4) 

loc_8c0ddfba:
mov.l @(bank0d.loc_8c0de064,pc),r2
jmp @r2
nop 
...
loc_8c0de278:
mov 0x34,r0
mov.l @(bank0d.loc_8c0de390,pc),r3
mov r0,r1
add r5,r1
fmov.s @(r0,r4),fr2
mov 0x3B,r6
...
loc_8c0de6d6:
mov.w @(bank0d.loc_8c0de73a,pc),r0
mov.l @(bank0d.loc_8c0de74c,pc),r6
add r5,r0
mov.w @(bank0d.loc_8c0de73a,pc),r3
mov.b @(0x01,r0),r0 
add r5,r3
shll r0
shll2 r0
...
loc_8c0de70e:
mov 0x34,r0
mov.l @(bank0d.loc_8c0de744,pc),r3
mov r0,r1
add r5,r1
fmov.s @(r0,r4),fr2
fmov.s @r1,fr3
...
mov 0x01,r0
mov.b r0,@(0x06,r14) 
bsr bank0d.loc_8c0df198
mov r14,r4
bsr bank0d.loc_8c0df0a6
mov r14,r4
mov 0x07,r0
mov.w r0,@(0x1C,r14) 
...
bsr loc_8c0df0a6
mov r14,r4
mov.l @(bank0d.loc_8c0df01c,pc),r2
jsr @r2
nop 
mov.l @(bank0d.loc_8c0df020,pc),r1
mov 0x22,r3
and 0x03,r0 
add r14,r3
mov.b @(r0,r1),r0
...
mov.l @(bank0d.loc_8c0df03c,pc),r1
fmov.s @r0,fr3
...
mov 0x00,r5
mov.l @(bank0d.loc_8c0df180,pc),r7
...
mov.l @(bank0d.loc_8c0df184,pc),r3
mov.l @(r0,r4),r2
add r4,r1
jsr @r3
mov 0x08,r0
...
mov.l @(0x18,r14),r4
mov r15,r5
mov.l @(bank0d.loc_8c0df188,pc),r3
fmov.s @(r0,r4),fr2
mov 0x60,r0
fadd fr3,fr2
fmov.s fr2,@r15
...
loc_8c0df116:
mov 0x22,r3
mov.l @(bank0d.loc_8c0df18c,pc),r4
add r14,r3
mov.b @(0x07,r14),r0 
mov.b @r3,r3
extu.b r3,r3
...
bt loc_8c0df144
mov 0x22,r0
mov.l @(bank0d.loc_8c0df190,pc),r3
mov.b @(r0,r14),r0
mov 0x1B,r5
extu.b r0,r0
mov.b @(r0,r4),r0
...
mov.l r3,@r15
mov.w @(0x04,r3),r0 
mov.l @(bank0d.loc_8c0df194,pc),r3
mov r0,r5
jmp @r3
add 0x04,r15
...
loc_8c0df470:
mov.w @(bank0d.loc_8c0df48c,pc),r0
mov.w @(r0,r14),r2
tst r2,r2
bt/s loc_8c0df47c
fldi0 fr3
...
loc_8c0df4b6:
mov.w @(bank0d.loc_8c0df554,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0df4c8
mov 0x1B,r5
...
loc_8c0df4c8:
bsr bank0d.loc_8c0df638
mov r14,r4
bra bank0d.loc_8c0df53e
nop 
...
loc_8c0dfac2:
mov 0x34,r0
mov.l @(bank0d.loc_8c0dfb8c,pc),r3
fmov.s @(r0,r13),fr3
mov 0x1B,r5
mov 0x35,r6
fadd fr4,fr3
...
mov r2,r0
nop 
mov.l @(bank0d.loc_8c0dfb90,pc),r3
add 0x69,r0
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
...
loc_8c0dfaec:
mov.l @(bank0d.loc_8c0dfb94,pc),r2
jsr @r2
mov r14,r4
