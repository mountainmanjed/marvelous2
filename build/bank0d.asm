...
loc_8C0D7BD0:
	...
	fmov @(r0,r4),fr3
	fcmp/gt fr3,fr1
	bt loc_8c0d7c1c               ; loc_8c0d7bd0+0x4c
...
loc_8C0DBE7A:
	...
	mov.b @(0xA,r6),r0
	tst r0,r0
	bt loc_8c0dbedc               ; loc_8c0dbeae+0x2e
...
loc_8c0dde08:
	...
	mov r6,r4
	tst r0,r0
	bt.s loc_8c0dde9e             ; loc_8c0dde38+0x66
	mov r0,r4
	mov.w @(0x13E,PC),r2
	mov 0x26,r0
	mov.l @(0x4,r15),r3
	...
	mov.b @r15,r2
	tst r2,r2
	bt loc_8c0dde9e               ; loc_8c0dde38+0x66
	mov.l @(0x140,PC),r2
	mov.w @(0x12A,PC),r0
	mov.l r2,@(0x10,r4)
	mov.w @(0x126,PC),r1
...
loc_8c0de338:
	...
	bf.s loc_8c0de364
	mov 0x1B,r5
	bra loc_8c0de366              ; loc_8c0de2c4+0xa2
	mov 0x7A,r6
...
loc_8C0DE7A4:
	...
	extu.b r0,r0
	cmp/eq 0x1D,r0
	bf loc_8c0de7d2               ; loc_8c0de7bc+0x16
	mov.w @(0xC8,PC),r0
	mov.b @(r0,r4),r0
	extu.b r0,r0
	cmp/eq 0x01,r0
...
loc_8C0DE8BC:
	...
	extu.b r0,r0
	cmp/eq 0x1D,r0
	bf loc_8c0de984               ; loc_8c0de968+0x1c
	mov.w @(0xE2,PC),r0
	mov.b @(r0,r13),r0
	extu.b r0,r0
	cmp/eq 0x01,r0
	...
	extu.b r3,r3
	tst r3,r3
	bf loc_8c0de9aa               ; loc_8c0de908+0xa2
	mov.b @(0x5,r14),r0
	mov 0xF8,r3
	add 0x01,r0
	mov.b r0,@(0x5,r14)
...
loc_8C0DEE22:
	...
	cmp/gt r3,r0
	bf loc_8c0dee2e
	bra loc_8c0df040              ; loc_8c0deefc+0x144
	nop
...
loc_8C0DF230:
	...
	mov r6,r4
	tst r0,r0
	bt.s loc_8c0df264             ; loc_8c0df262+0x2
	mov r0,r4
	mov 0x00,r5
	mov.l @(0x134,PC),r3
	mov 0x20,r0
...
loc_8C0DF690:
	...
	mov r6,r4
	tst r0,r0
	bt.s loc_8c0df6d0             ; loc_8c0df6ac+0x24
	mov r0,r4
	mov.l @(0xFC,PC),r3
	mov 0x20,r0
	mov.l r3,@(0x10,r4)
