...
loc_8c0c07f2:
mov.l @(bank0c.loc_8c0c0840,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt bank0c.loc_8c0c0806
...
loc_8c0c0c00:
mov.l @(bank0c.loc_8c0c0c8c,pc),r2
mov 0x1B,r5
mov 0x01,r6
jsr @r2
mov r14,r4
...
fmov.s @r1,fr3
fmov.s @(r0,r14),fr2
mov.l @(bank0c.loc_8c0c0c90,pc),r3
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
jsr @r3
mov r14,r4
...
cmp/pz r0
bt loc_8c0c0c70
mov.w @(bank0c.loc_8c0c0c88,pc),r0
mov 0x00,r3
mov.b r3,@(r0,r14) 
mov 0x03,r0
mov.b r0,@(0x04,r14) 
...
#align4
loc_8c0c0e28:
mov.l @(bank0c.loc_8c0c0eb4,pc),r2
mov 0x17,r5
mov 0x04,r6
jsr @r2
mov r14,r4
...
mov 0x34,r0
add r0,r3
mov.l @(bank0c.loc_8c0c0ec4,pc),r0
mov.l r3,@-r15
mov 0x20,r3
add r14,r3
mov.b @r3,r3
...
tst r2,r2
bf loc_8c0c0e96
mov.l @(bank0c.loc_8c0c0ed0,pc),r3
mov 0x0A,r5
jsr @r3
mov r14,r4
...
loc_8c0c120c:
mov.w @(bank0c.loc_8c0c12bc,pc),r0
mov 0x00,r5
mov.b r5,@(r0,r4) 
mov 0x34,r0
mov.l @(0x18,r4),r3
...
mov.w @(bank0c.loc_8c0c12bc,pc),r0
mov 0x01,r2
mov.l @(bank0c.loc_8c0c12c4,pc),r7
mov.b r2,@(r0,r4) 
add 0x1F,r0
mov.l @(0x18,r4),r6
mov.b @(r0,r6),r0
...
sts.l pr,@-r15
add 0xFC,r15
mov.l @(bank0c.loc_8c0c1374,pc),r3
mov 0x03,r5
mov.l r4,@r15
mov 0x00,r6
jsr @r3
...
bt/s loc_8c0c1334
mov r0,r4
mov.l @(bank0c.loc_8c0c1378,pc),r3
mov 0x20,r0
mov.l r3,@(0x10,r4) 
mov.l @r15,r2
mov.l @(0x18,r2),r3
...
loc_8c0c17e2:
mov.l @(bank0c.loc_8c0c187c,pc),r3
mov 0x07,r5
jsr @r3
mov.l @(0x18,r14),r4
mov.w @(0x1E,r14),r0 
tst r0,r0
bt loc_8c0c1868
mov.l @(bank0c.loc_8c0c1880,pc),r3
mov 0x03,r5
mov 0x00,r6
jsr @r3
mov r6,r4
...
mov 0x20,r1
mov.l @(bank0c.loc_8c0c1884,pc),r3
add r12,r1
mov.l r3,@(0x10,r12) 
mov 0x00,r3
mov.l @r2,r0
...
mov.l r1,@(0x18,r12) 
mov.l @(r0,r13),r0
mov.l @(bank0c.loc_8c0c188c,pc),r1
mov.b @(0x01,r0),r0 
mov.b r0,@(0x01,r12) 
mov 0x26,r0
jsr @r1
...
and 0x3F,r0 
mov.l @(bank0c.loc_8c0c188c,pc),r3
add 0xE0,r0
add r12,r1
jsr @r3
mov.l r0,@r1
...
loc_8c0c1852:
mov.l @(bank0c.loc_8c0c187c,pc),r2
mov 0x01,r5
jsr @r2
mov.l @(0x18,r14),r4
...
loc_8c0c185a:
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0c1890,pc),r3
mov r14,r4
mov.l @r15+,r12
mov.l @r15+,r13
jmp @r3
...
loc_8c0c1978:
mov.w @(bank0c.loc_8c0c19d0,pc),r0
mov r14,r4
mov.b r5,@(r0,r14) 
add 0xA0,r0
mov.l @(r0,r14),r3
...
fmov.s @r0,fr0
mov 0x38,r0
mov.l @(bank0c.loc_8c0c19ec,pc),r3
float fpul,fr3
fmac fr0,fr3,fr2
fmov.s fr2,@(r0,r14) 
lds.l @r15+,pr 
...
mov.b @(0x05,r14),r0 
mov r14,r4
mov.l @(bank0c.loc_8c0c19e0,pc),r3
mov 0x04,r6
add 0x01,r0
mov.b r0,@(0x05,r14) 
mov 0x1B,r5
...
loc_8c0c19f0:
mov.l @(bank0c.loc_8c0c1a10,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
...
loc_8c0c19fc:
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0c1a14,pc),r3
mov r14,r4
mov.l @r15+,r13
jmp @r3
mov.l @r15+,r14
...
loc_8c0c2b54:
mov.l @(bank0c.loc_8c0c2c3c,pc),r3
jsr @r3
nop 
mov.l @r15,r5
mov r14,r4
...
bt loc_8c0c2da0
exts.b r5,r7
mov.w @(bank0c.loc_8c0c2e4a,pc),r0
cmp/pz r7
mov 0x01,r2
bt/s loc_8c0c2d30
mov.b r2,@(r0,r4) 
...
mov 0xFC,r3
shad r3, r7
mov.l @(bank0c.loc_8c0c2e58,pc),r3
add 0xFF,r7
exts.b r7,r5
shll2 r5
shll r5
...
mov.w r3,@(r0,r4) 
mov 0x31,r0
mov.l @(bank0c.loc_8c0c2e64,pc),r3
jmp @r3
mov.b r2,@(r0,r4) 
...
tst r2,r2
bt loc_8c0c2ee0
mov.w @(bank0c.loc_8c0c2f94,pc),r0
mov 0xFE,r2
mov.w @(r0,r4),r3
mov.w r3,@(r0,r14) 
mov 0x31,r0
...
tst r3,r3
bf loc_8c0c2ec2
mov.l @(bank0c.loc_8c0c2fa0,pc),r3
jsr @r3
mov r14,r4
...
loc_8c0c2eda:
mov.w @(bank0c.loc_8c0c2f90,pc),r0
mov 0x01,r2
mov.b r2,@(r0,r14) 
...
loc_8c0c2ff0:
mov.w @(bank0c.loc_8c0c3004,pc),r0
mov 0x00,r2
bra loc_8c0c2ffe
mov.b r2,@(r0,r4) 
...
tst r3,r3
bt loc_8c0c3856
mov.l @(bank0c.loc_8c0c3894,pc),r3
jsr @r3
mov r14,r4
exts.b r0,r0
cmp/pz r0
bt loc_8c0c3856
mov.w @(bank0c.loc_8c0c3870,pc),r0
mov 0x00,r4
mov.b r4,@(r0,r14) 
mov.b r4,@r12
...
cmp/pl r14
mov.l @(bank0c.loc_8c0c39a8,pc),r10
bf loc_8c0c390a
...
mov r14,r0
nop 
mov.l @(bank0c.loc_8c0c39ac,pc),r3
mov.w r0,@(0x1E,r4) 
mov.l r3,@(0x10,r4) 
mov.l @r15,r2
mov.l r2,@(0x18,r4) 
...
loc_8c0c3b16:
mov.w @(bank0c.loc_8c0c3c58,pc),r0
add 0x01,r5
cmp/ge r6,r5
mov.b r2,@(r0,r4) 
bf/s bank0c.loc_8c0c3a86
mov.l @(0x0C,r4),r4
...
sts.l pr,@-r15
mov.w @(0x1E,r14),r0 
mov.l @(bank0c.loc_8c0c3c64,pc),r10
mov r0,r9
add 0xFF,r9
cmp/pl r9
mov r0,r5
...
mov.b @(r0,r14),r8
mov 0x17,r5
mov.l @(bank0c.loc_8c0c3c68,pc),r0
extu.b r8,r8
mov.b @(r0,r8),r8
mov 0x22,r0
mov.b @(r0,r14),r7
...
mov r14,r4
mov.l @(bank0c.loc_8c0c3c6c,pc),r3
mov.l @r15+,r8
mov.l @(r0,r14),r5
mov.l @r15+,r9
mov.l @r15+,r10
...
loc_8c0c4128:
mov.l @(bank0c.loc_8c0c4258,pc),r3
jsr @r3
mov r14,r4
mov 0x5C,r1
mov 0x34,r0
...
mov.l @(bank0c.loc_8c0c47cc,pc),r3
add r4,r1
mov.w @(loc_8C0C47C0,pc),r2
jsr @r3
add r5,r2
mov.w @(bank0c.loc_8c0c47be,pc),r0
mov r4,r1
add 0x50,r1
mov.b r13,@(r0,r4) 
mov.b @(0x02,r5),r0 
...
add 0x50,r2
mov.b r3,@(r0,r4) 
mov.l @(bank0c.loc_8c0c47d0,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov r4,r1
...
mov 0x01,r12
mov.l @(bank0c.loc_8c0c4870,pc),r9
mov.l @(bank0c.loc_8c0c486c,pc),r8
add r5,r3
mov.l r3,@r15
mov.w @(0x1E,r14),r0 
mov r0,r10
...
add 0x04,r15
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0c4874,pc),r3
mov.l @r15+,r8
mov.l @r15+,r9
mov.l @r15+,r10
mov.l @r15+,r11
...
add r4,r1
mov.l @(bank0c.loc_8c0c4ea4,pc),r3
jsr @r3
add r14,r2
...
add 0x50,r2
mov.b r3,@(r0,r4) 
mov.l @(bank0c.loc_8c0c4ea8,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov.l @(bank0c.loc_8c0c4ea8,pc),r3
...
loc_8c0c4e74:
mov.l @(bank0c.loc_8c0c4eac,pc),r3
mov r13,r5
jsr @r3
mov r14,r4
...
mov.l @(bank0c.loc_8c0c53bc,pc),r3
add r4,r1
...
add 0x50,r2
mov.b r3,@(r0,r4) 
mov.l @(bank0c.loc_8c0c53c0,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov r4,r1
...
cmp/pl r14
mov.l @(bank0c.loc_8c0c6940,pc),r10
bf loc_8c0c6882
...
mov r14,r0
nop 
mov.l @(bank0c.loc_8c0c6944,pc),r3
mov.w r0,@(0x1E,r4) 
mov.l r3,@(0x10,r4) 
mov.l @r15,r2
mov.l r2,@(0x18,r4) 
...
loc_8c0c6a82:
mov.w @(bank0c.loc_8c0c6b50,pc),r0
mov r4,r1
add 0x34,r1
mov.b r3,@(r0,r4) 
mov 0x24,r0
mov.b @(r0,r14),r2
mov.l @(bank0c.loc_8c0c6b54,pc),r3
mov.b r2,@(r0,r4) 
mov r14,r2
mov 0x31,r0
add 0x34,r2
...
sts.l pr,@-r15
mov.w @(0x1E,r14),r0 
mov.l @(bank0c.loc_8c0c6b5c,pc),r10
mov r0,r9
add 0xFF,r9
cmp/pl r9
mov r0,r5
...
mov.b @(r0,r14),r8
mov 0x17,r5
mov.l @(bank0c.loc_8c0c6b60,pc),r0
extu.b r8,r8
mov.b @(r0,r8),r8
mov 0x22,r0
mov.b @(r0,r14),r7
...
mov r14,r4
mov.l @(bank0c.loc_8c0c6b64,pc),r3
mov.l @r15+,r8
mov.l @(r0,r14),r5
mov.l @r15+,r9
mov.l @r15+,r10
...
loc_8c0c7086:
mov.w @(bank0c.loc_8c0c7106,pc),r0
mov.l @(bank0c.loc_8c0c711c,pc),r3
mov.b r12,@(r0,r13) 
jsr @r3
mov r13,r4
tst r0,r0
...
mov.l @(bank0c.loc_8c0c7110,pc),r3
mov.b r11,@(r0,r14) 
mov.w @(0x1C,r14),r0 
add 0xF9,r0
mov.w r0,@(0x1C,r14) 
jsr @r3
mov r14,r4
mov.l @(bank0c.loc_8c0c7118,pc),r2
mov 0x0A,r5
jsr @r2
mov r13,r4
...
exts.w r0,r0
cmp/pz r0
bt bank0c.loc_8c0c70f6
mov.w @(bank0c.loc_8c0c710a,pc),r0
mov 0x08,r2
mov 0x0A,r3
mov.b r2,@(r0,r13) 
add 0xFC,r0
mov.b r3,@(r0,r13) 
mov.w @(bank0c.loc_8c0c7106,pc),r0
mov.l @(bank0c.loc_8c0c7120,pc),r3
mov.b r11,@(r0,r13) 
jsr @r3
mov r13,r4
mov 0x02,r0
...
mov 0x00,r14
mov.l @(bank0c.loc_8c0c7288,pc),r8
mov 0x01,r11
mov 0x02,r10
...
mov.b r3,@(r0,r4) 
mov 0x23,r0
mov.l @(bank0c.loc_8c0c728c,pc),r3
mov.b @(r0,r12),r1
mov.b r1,@(r0,r4) 
mov.l r3,@(0x10,r4) 
mov.l @r15,r2
...
mov.l @(bank0c.loc_8c0c76ec,pc),r3
add r4,r1
...
add 0x50,r2
mov.b r3,@(r0,r4) 
mov.l @(bank0c.loc_8c0c76f0,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov r4,r1
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0c.loc_8c0c8798,pc),r3
jsr @r3
mov r4,r14
mov 0x5C,r1
add r14,r1
...
fmov.s @(r0,r4),fr3
mov 0x03,r5
mov.l @(bank0c.loc_8c0c8a34,pc),r3
mov 0x02,r6
fadd fr4,fr3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
...
bt/s loc_8c0c89d6
mov r0,r13
mov.l @(bank0c.loc_8c0c8a38,pc),r3
mov.l r3,@(0x10,r13) 
mov.l @r15,r2
mov.l r2,@(0x18,r13) 
mov.w @(0x1E,r14),r0 
...
fmov.s @(r0,r4),fr3
mov 0x03,r5
mov.l @(bank0c.loc_8c0c8c44,pc),r3
mov 0x02,r6
fadd fr4,fr3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
...
bt/s loc_8c0c8ba8
mov r0,r13
mov.l @(bank0c.loc_8c0c8c48,pc),r3
mov.l r3,@(0x10,r13) 
mov.l @r15,r2
mov.l r2,@(0x18,r13) 
mov.w @(0x1E,r14),r0 
...
fmov.s @(r0,r4),fr3
mov 0x04,r5
mov.l @(bank0c.loc_8c0c8e90,pc),r3
mov 0x02,r6
fadd fr4,fr3
fmov.s fr3,@(r0,r14) 
mov 0x38,r0
...
bt/s loc_8c0c8dc6
mov r0,r13
mov.l @(bank0c.loc_8c0c8e94,pc),r3
mov.l r3,@(0x10,r13) 
mov.l @r15,r2
mov.l r2,@(0x18,r13) 
mov.w @(0x1E,r14),r0 
...
fmov.s @r1,fr3
fmov.s @(r0,r4),fr2
mov.l @(bank0c.loc_8c0c93bc,pc),r3
fadd fr3,fr2
fldi0 fr3
fmov.s fr2,@(r0,r4) 
mov 0x20,r0
...
mov r0,r2
lds r2,fpul 
mov.w @(bank0c.loc_8c0c93a8,pc),r0
float fpul,fr2
fmov.s @(r0,r5),fr1
...
fmov.s @r0,fr3
mov 0x60,r0
mov.l @(bank0c.loc_8c0c9544,pc),r3
mov 0x1B,r5
fmov.s fr3,@(r0,r14) 
...
sts.l pr,@-r15
add 0xFC,r15
mov.l @(bank0c.loc_8c0c9548,pc),r3
mov r4,r14
mov.l r5,@r15
jsr @r3
mov r14,r4
...
mov.l @(0x18,r14),r13
mov.l @(bank0c.loc_8c0c9840,pc),r3
jsr @r3
add r13,r2
...
add 0x50,r2
mov.b r3,@(r0,r14) 
mov.l @(bank0c.loc_8c0c9844,pc),r3
jsr @r3
mov 0x0C,r0
mov 0x24,r0
mov.b @(r0,r13),r2
...
mov 0x24,r0
mov.b r3,@(r0,r14) 
mov.l @(bank0c.loc_8c0c9848,pc),r3
jsr @r3
mov r14,r4
mov.l @(bank0c.loc_8c0c984c,pc),r2
jsr @r2
mov r14,r4
mov 0x04,r0
mov.w r0,@(0x1E,r14) 
...
#align4
loc_8c0c9b54:
mov.w @(bank0c.loc_8c0c9bf0,pc),r1
mov.b @(0x06,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
mov.w @(bank0c.loc_8c0c9bf2,pc),r1
mov.b @(0x07,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
...
#align4
loc_8c0c9f40:
mov.w @(bank0c.loc_8c0ca012,pc),r0
mov 0x01,r1
mov.w r1,@(r0,r14) 

loc_8c0c9f46:
mov.l @(bank0c.loc_8c0ca030,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
mov.l @r15,r5
...
mov.b @(0x07,r14),r0 
mov 0x40,r6
mov.w @(bank0c.loc_8c0ca012,pc),r1
add 0x01,r0
mov.l @(bank0c.loc_8c0ca030,pc),r3
mov.b r0,@(0x07,r14) 
add r14,r1
...
loc_8c0ca000:
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0ca01c,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
#data 0x4F26
...
#align4
loc_8c0ca1cc:
mov.w @(bank0c.loc_8c0ca2d4,pc),r0
mov 0x01,r1
mov.w r1,@(r0,r14) 

loc_8c0ca1d2:
mov.l @(bank0c.loc_8c0ca2e8,pc),r3
mov 0x17,r5
jsr @r3
mov r14,r4
lds.l @r15+,pr 
...
loc_8c0ca280:
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0ca2ec,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
#data 0x4F26
...
loc_8c0ca3ce:
mov 0x5C,r0
mov.l @(bank0c.loc_8c0ca424,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x68,r0
fldi0 fr3
mov 0x17,r5
...
loc_8c0ca48c:
mov.l @(bank0c.loc_8c0ca508,pc),r3
jsr @r3
mov r14,r4
...
mov.b @(0x07,r14),r0 
mov r14,r4
mov.l @(bank0c.loc_8c0ca50c,pc),r3
mov 0x45,r6
add 0x01,r0
mov.b r0,@(0x07,r14) 
mov 0x17,r5
...
mov 0x0A,r0
mov.w r0,@(0x1C,r14) 
mov.w @(bank0c.loc_8c0ca4f4,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bf loc_8c0ca518
...
loc_8c0ca560:
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0ca654,pc),r3
mov r14,r4
mov.l @r15+,r13
jmp @r3
mov.l @r15+,r14
...
loc_8c0ca66a:
mov.l @(bank0c.loc_8c0ca74c,pc),r3
jsr @r3
mov r14,r4
mov.l @(bank0c.loc_8c0ca750,pc),r2
mov 0x17,r5
mov 0x0F,r6
jsr @r2
mov r14,r4
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0c.loc_8c0ca754,pc),r3
jsr @r3
mov r4,r14
...
loc_8c0ca95e:
mov.w @(bank0c.loc_8c0ca99a,pc),r1
mov.b @(0x06,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
mov.w @(bank0c.loc_8c0ca99c,pc),r1
mov.b @(0x07,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
...
mov 0x0D,r6
mov.l @(bank0c.loc_8c0cab04,pc),r3
fmov.s @(r0,r13),fr3
mov 0x38,r0
fmov.s fr3,@(r0,r14) 
jsr @r3
...
mov.l r14,@-r15
sts.l pr,@-r15
mov.l @(bank0c.loc_8c0cab08,pc),r3
jsr @r3
mov r4,r14
mov 0x5C,r1
add r14,r1
...
loc_8c0cac96:
mov.w @(bank0c.loc_8c0cad3a,pc),r0
mov 0x01,r2
mov.w r2,@(r0,r14) 
...
loc_8c0caca0:
mov 0x5C,r0
mov.l @(bank0c.loc_8c0cad48,pc),r3
fmov.s fr3,@(r0,r14) 
mov 0x68,r0
fldi0 fr3
mov 0x17,r5
...
sts.l pr,@-r15
add 0xFC,r15
mov.l @(bank0c.loc_8c0cad4c,pc),r3
mov r4,r14
mov.l r5,@r15
jsr @r3
mov r14,r4
...
fldi0 fr3
fmov.s fr3,@(r0,r14) 
mov.w @(bank0c.loc_8c0cb0f0,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt loc_8c0cb088
mov 0x5C,r0
...
cmp/eq r3,r0
bt loc_8c0cb0a0
mov.l @(bank0c.loc_8c0cb108,pc),r3
mov 0x17,r5
mov 0x0C,r6
jsr @r3
mov r14,r4
...
#align4
loc_8c0cb154:
mov.w @(bank0c.loc_8c0cb23c,pc),r0
mov 0x01,r2
mov.w r2,@(r0,r14) 
...
cmp/eq r3,r0
bt loc_8c0cb180
mov.l @(bank0c.loc_8c0cb254,pc),r3
mov 0x17,r5
mov 0x0D,r6
jsr @r3
mov r14,r4
...
#align4
loc_8c0cb278:
mov.w @(bank0c.loc_8c0cb36c,pc),r1
mov.b @(0x06,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
mov.w @(bank0c.loc_8c0cb36e,pc),r1
mov.b @(0x07,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
...
loc_8c0cb552:
mov.w @(bank0c.loc_8c0cb5dc,pc),r1
mov.b @(0x06,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
mov.w @(bank0c.loc_8c0cb5de,pc),r1
mov.b @(0x07,r14),r0 
add r14,r1
extu.b r0,r0
mov.l r0,@r1
bra bank0c.loc_8c0cb6fc
mov 0x01,r0

loc_8c0cb56a:
mov.w @(bank0c.loc_8c0cb5d8,pc),r0
mov.b @(r0,r13),r0
extu.b r0,r0
cmp/eq 0x1C,r0 
bf loc_8c0cb594
...
loc_8c0cb594:
mov.l @(bank0c.loc_8c0cb5f0,pc),r2
jsr @r2
mov r14,r4
tst r0,r0
bf loc_8c0cb5b6
...
mov 0x5C,r0
fmov.s fr3,@(r0,r14) 
mov.w @(bank0c.loc_8c0cb910,pc),r0
mov.w @(r0,r14),r3
tst r3,r3
bt/s loc_8c0cb8d6
fldi0 fr4
...
loc_8c0cb8d6:
mov 0x68,r0
mov.l @(bank0c.loc_8c0cb93c,pc),r3
fmov.s fr4,@(r0,r14) 
mov 0x60,r0
fmov.s fr4,@(r0,r14) 
mov 0x6C,r0
...
add 0x01,r0
mov.b r0,@(0x05,r4) 
mov.w @(bank0c.loc_8c0cb9de,pc),r0
mov.b r3,@(r0,r4) 
...
cmp/gt r3,r0
bt loc_8c0cbdce
mov.w @(bank0c.loc_8c0cbde6,pc),r1
mov.w @(0x1C,r4),r0 
add r4,r1
and 0x01,r0 
mov.b r0,@r1
...
loc_8c0ccc70:
mov.l @(bank0c.loc_8c0ccde0,pc),r2
jsr @r2
mov r14,r4
mov 0x5C,r1
add r14,r1
...
fmov.s @r15+,fr15
mov.l @r15+,r13
bra bank0c.loc_8c0cd9d4
mov.l @r15+,r14

loc_8c0ccce6:
mov.l @(loc_8C0CCDE4,pc),r3
mov.w @(bank0c.loc_8c0ccdd8,pc),r1
mov.l @r3,r0
add r14,r1
mov.l @(0x1C,r0),r0
and 0x01,r0 
...
loc_8c0cd140:
mov r4,r2
mov.l @(bank0c.loc_8c0cd1c0,pc),r0
shll2 r2
shll r2
fmov.s @(r0,r2),fr3
fneg fr3
...
loc_8c0cd14c:
mov 0x34,r0
mov.l @(bank0c.loc_8c0cd1c8,pc),r3
fmov.s @(r0,r13),fr2
shll2 r4
shll r4
fadd fr3,fr2
fmov.s fr2,@(r0,r14) 
mov.l @(bank0c.loc_8c0cd1c4,pc),r0
fmov.s @(r0,r4),fr3
mov 0x38,r0
fmov.s @(r0,r13),fr2
fadd fr3,fr2
...
loc_8c0cd188:
mov.l @(bank0c.loc_8c0cd1d0,pc),r3
mov 0x27,r5
jsr @r3
mov r14,r4
lds.l @r15+,pr 
...
mov.w @(bank0c.loc_8c0cd466,pc),r0
lds r1,fpul 
fmov.s @(r0,r14),fr2
fldi0 fr1
fsts fpul,fr3
...
lds.l @r15+,pr 
mov 0x07,r7
mov.l @(bank0c.loc_8c0cd700,pc),r3
mov r14,r4
and r0,r7
mov.l @r15+,r13
mov 0x19,r6
...
loc_8c0cd7f0:
mov.l @(bank0c.loc_8c0cd848,pc),r3
jsr @r3
mov r14,r4
...
mov.b r3,@(r0,r14) 
mov 0x07,r5
mov.l @(bank0c.loc_8c0cf9ac,pc),r3
jsr @r3
mov r14,r4

loc_8c0cf91e:
mov.w @(bank0c.loc_8c0cf998,pc),r0
mov.b @(r0,r14),r2
cmp/pz r2
bf loc_8c0cf930
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0cf9b0,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
...
mov.w @(loc_8C0CFACA,pc),r0
mov 0x00,r2
mov.l @(bank0c.loc_8c0cfadc,pc),r3
mov 0x09,r5
mov.b r2,@(r0,r14) 
jsr @r3
mov r14,r4
mov.l @(bank0c.loc_8c0cfadc,pc),r2
mov 0x08,r5
jsr @r2
mov r14,r4
...
bf loc_8c0cfab0
lds.l @r15+,pr 
mov.l @(bank0c.loc_8c0cfae0,pc),r2
mov r14,r4
jmp @r2
mov.l @r15+,r14
...
loc_8c0cfbdc:
mov.w @(bank0c.loc_8c0cfc02,pc),r0
mov.b @(r0,r4),r3
cmp/pz r3
bf loc_8c0cfbea
mov.l @(bank0c.loc_8c0cfc10,pc),r3
jmp @r3
nop 
...
loc_8c0cff4e:
mov.w @(bank0c.loc_8c0d0034,pc),r0
mov.b @(r0,r4),r0
extu.b r0,r0
cmp/eq 0x02,r0 
bf bank0c.loc_8c0cfffc
mov 0x21,r0
mov 0x03,r7
mov.b r7,@(r0,r14) 
mov.w @(bank0c.loc_8c0d0034,pc),r0
