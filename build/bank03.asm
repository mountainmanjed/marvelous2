...
loc_8c0312d6:
	...
	mov 0x0C,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c031464,PC),r0
	fmov @r0,fr13
	mova @(loc_8c031468,PC),r0
	cmp/pl r11
	fmov @r0,fr14
...
loc_8c033956:
	...
	mov 0x20,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a1c,PC),r0
	fmov @r0,fr3
	mov 0x24,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a20,PC),r0
	fmov @r0,fr3
	mov 0x28,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a24,PC),r0
	fmov @r0,fr3
	mov 0x2C,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a28,PC),r0
	fmov @r0,fr3
	mov 0x30,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a2c,PC),r0
	fmov @r0,fr3
	mov 0x34,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a30,PC),r0
	fmov @r0,fr3
	mov 0x38,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c033a34,PC),r0
...
loc_8c036e00:
	...
	tst r3,r3
	bt loc_8c036e42
	mova @(loc_8c036e98,PC),r0
	fmov @r0,fr3
	mov 0x10,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c036e9c,PC),r0
	fmov @r0,fr3
	mov 0x14,r0
	fmov fr3,@(r0,r4)
...
loc_8c03750a:
	...
	mov 0x0A,r0
	mov.w r0,@(0xA,r14)
	mova @(loc_8c03757c,PC),r0
	fmov @r0,fr3
	mov 0x10,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c037580,PC),r0
	fmov @r0,fr3
	mov 0x14,r0
	fmov fr3,@(r0,r14)
	mov 0x19,r0
...
loc_8c037808:
	...
	mov 0x0A,r0
	mov.w r0,@(0xA,r14)
	mova @(loc_8c037914,PC),r0
	fmov @r0,fr3
	mov 0x10,r0
	fmov fr3,@(r0,r14)
	mova @(loc_8c037918,PC),r0
	fmov @r0,fr3
	mov 0x14,r0
	fmov fr3,@(r0,r14)
	mov 0x19,r0
...
loc_8c03a6fa:
	...
	mov 0x0C,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c03a7e4,PC),r0
	fmov @r0,fr3
	mov 0x10,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c03a7e8,PC),r0
	fmov @r0,fr3
	mov 0x14,r0
	fmov fr3,@(r0,r4)
	mov 0x54,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c03a7ec,PC),r0
	fmov @r0,fr3
	mov 0x58,r0
	fmov fr3,@(r0,r4)
	mov 0x5C,r0
...
loc_8c040002:
	...
	mov 0x38,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c040078,PC),r0
	fmov @r0,fr3
	mov 0x3C,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c04007c,PC),r0
	fmov @r0,fr4
	mov 0x50,r0
	fmov fr4,@(r0,r4)
	mov 0x54,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c040080,PC),r0
	fmov @r0,fr3
	mov 0x58,r0
	fmov fr3,@(r0,r4)
...
loc_8c040194:
	...
	mov 0x38,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c040234,PC),r0
	fmov @r0,fr3
	mov 0x3C,r0
	fmov fr3,@(r0,r4)
	mova @(loc_8c040238,PC),r0
	fmov @r0,fr4
	mov 0x50,r0
	fmov fr4,@(r0,r4)
	mov 0x54,r0
	fmov fr4,@(r0,r4)
	mova @(loc_8c04023c,PC),r0
	fmov @r0,fr3
	mov 0x58,r0
	fmov fr3,@(r0,r4)
