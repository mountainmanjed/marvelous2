...
;1bit 48x32
loc_8c169efc:
	;#import_raw_data "graphics/VMUBasic.bin"
	#data 0xff 0xff 0xff 0xff 0xff 0xff
	#data 0xff 0xff 0xff 0xff 0xff 0xff
	#data 0xff 0xff 0xff 0xff 0xff 0xff
	#data 0x00 0x00 0x00 0xff 0xff 0xff
	#data 0x7f 0xff 0xfe 0x80 0x0f 0xff
	#data 0x56 0xc5 0x4a 0x3f 0xe3 0xff
	#data 0x45 0x55 0x5a 0xe0 0x39 0xff
	#data 0x45 0x4d 0x4b 0x80 0x0d 0xff
	#data 0x54 0x55 0x5b 0x3f 0x05 0xff
	#data 0x55 0x56 0xc9 0xff 0x85 0xff
	#data 0x7f 0xff 0xff 0xff 0x84 0x00
	#data 0x00 0x7b 0xcf 0xff 0xff 0xfe
	#data 0xff 0x5b 0xbf 0x9b 0x12 0x2a
	#data 0xff 0x5b 0xbf 0xb5 0x56 0xa2
	#data 0xff 0x5d 0x5f 0xb1 0x36 0xa2
	#data 0xff 0x5d 0x6f 0xb5 0x76 0xaa
	#data 0xff 0x5e 0xef 0x95 0x72 0x2a
	#data 0xff 0x6e 0x9b 0xff 0xff 0xfe
	#data 0xff 0x2f 0xff 0xc3 0x00 0x00
	#data 0xff 0xb7 0xff 0x0e 0x7f 0xff
	#data 0xff 0x99 0xfc 0x38 0x0f 0xff
	#data 0xff 0xce 0x70 0xe3 0xef 0xff
	#data 0xff 0xe3 0x83 0x8e 0x6f 0xff
	#data 0xff 0x8e 0x0e 0x38 0xcf 0xff
	#data 0xff 0x38 0x3f 0xe1 0x9f 0xff
	#data 0xfe 0x60 0x00 0x03 0x3f 0xff
	#data 0xfe 0xc0 0x00 0x06 0x7f 0xff
	#data 0xfe 0xff 0xff 0xfc 0xff 0xff
	#data 0xfe 0x00 0x00 0x01 0xff 0xff
	#data 0xff 0xff 0xff 0xff 0xff 0xff
	#data 0xff 0xff 0xff 0xff 0xff 0xff
	#data 0xff 0xff 0xff 0xff 0xff 0xff
...
;1bit 48x32
loc_8c169fbc:
	;#import_raw_data "graphics/VMUAccess.bin"

	#data 0x00 0x00 0x00 0x00 0x00 0x00
	#data 0x16 0xff 0xff 0xff 0xff 0x68
	#data 0x16 0xf9 0xcc 0x8c 0xcf 0x68
	#data 0x16 0xf6 0xbb 0xbb 0xbf 0x68
	#data 0x16 0xf0 0xbb 0x8d 0xdf 0x68
	#data 0x16 0xf6 0xbb 0xbe 0xef 0x68
	#data 0x16 0xf6 0xcc 0x89 0x9f 0x68
	#data 0x16 0xff 0xff 0xff 0xff 0x68
	#data 0x00 0x00 0x00 0x00 0x00 0x00
	#data 0x7f 0xff 0xfe 0x00 0x00 0x00
	#data 0x56 0xc5 0x4a 0x3f 0xe0 0x00
	#data 0x45 0x55 0x5a 0x60 0x38 0x00
	#data 0x54 0x4d 0x4b 0x80 0x0c 0x00
	#data 0x55 0x56 0xc9 0x3f 0x04 0x00
	#data 0x7f 0xff 0xff 0xff 0x84 0x00
	#data 0x00 0x7b 0x8f 0xff 0xff 0xfe
	#data 0x00 0x5b 0xbf 0x9b 0x12 0x2a
	#data 0x00 0x59 0x1f 0xb5 0x56 0xa2
	#data 0x00 0x5d 0x4f 0xb1 0x36 0xaa
	#data 0x00 0x5c 0x6f 0x95 0x72 0x2a
	#data 0x00 0x6e 0x8b 0xff 0xff 0xfe
	#data 0x00 0x2f 0xff 0xc3 0x00 0x00
	#data 0x00 0x37 0xff 0x0e 0x00 0x00
	#data 0x00 0x19 0xfc 0x38 0x00 0x00
	#data 0x00 0x0e 0x70 0xe3 0xe0 0x00
	#data 0x00 0x03 0x83 0x8e 0x60 0x00
	#data 0x00 0x0e 0x0e 0x38 0xc0 0x00
	#data 0x00 0x38 0x3f 0xe1 0x80 0x00
	#data 0x00 0x60 0x00 0x03 0x00 0x00
	#data 0x00 0xc0 0x00 0x06 0x00 0x00
	#data 0x00 0xff 0xff 0xfc 0x00 0x00
	#data 0x00 0x00 0x00 0x00 0x00 0x00
