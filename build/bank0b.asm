...
loc_8C0BE25C:
	...
	sts.l pr,@-r15
	add 0xFC,r15
	mov.l @(loc_8C0BE3b0,PC),r3
	mov r4,r14
	mov.l r5,@r15
	jsr @r3
	mov r14,r4
	mov.w @(loc_8C0BE3A6,PC),r0
	mov.b @(r0,r14),r2
	tst r2,r2
	bt loc_8c0be2c6
	mov 0x00,r3
	...
	mov r7,r5
	mov.b @(r0,r6),r6
	mov.w @(loc_8C0BE3A8,PC),r0
	extu.b r6,r6
	mov.b @(r0,r14),r3
	shll2 r6
	mov.l @(loc_8C0BE3B4,PC),r0
	extu.b r3,r3
	mov.l @(r0,r6),r6
	add r3,r6
	mov.l @(loc_8C0BE3B8,PC),r3
	jsr @r3
	mov.l @r15,r4
...
loc_8c0be4c4:
	...
	mov r5,r0
	nop 
	mov.l @(loc_8C0BE600,PC),r3;loc_8c044F12
	mov 0x03,r5
	mov.b r0,@(0x4,r15)
	mov 0x00,r6
	jsr @r3
	...
	mov r0,r4
	mov 0x20,r1
	mov.l @(loc_8C0BE604,PC),r3;loc_8c0bE550
	add r4,r1
	mov.l r3,@(0x10,r4)
	mov 0x00,r3
	mov.l @r15,r2
