...
loc_8c1B6062:
	...
	bt loc_8c1b60a2
	cmp/eq 0x08,r0
	bt loc_8c1b60b8             ; loc_8c1b606c+0x4c
	cmp/eq 0x09,r0
	bt loc_8c1b60b8             ; loc_8c1b606c+0x4c
	cmp/eq 0x0C,r0
	bt loc_8c1b60b0
	bra loc_8c1b60c2              ; loc_8c1b606c+0x56
	nop
...
loc_8c1B6130:
	...
	mov 0x04,r4
	cmp/eq 0x01,r0
	bt loc_8c1b6172               ; loc_8c1b6104+0x6e
	cmp/eq 0x02,r0
	bt loc_8c1b6172               ; loc_8c1b6104+0x6e
	cmp/eq 0x08,r0
	bt loc_8c1b6188
	...
	cmp/eq 0x0C,r0
	bt loc_8c1b6180
	bra loc_8c1b6192              ; loc_8c1b6104+0x8e
	nop
...
loc_8c1B62B2:
	...
	mov r10,r5
	mov r12,r6
	bra loc_8c1b6310              ; loc_8c1b62de+0x32
	mov 0x00,r4
...
loc_8c1B6424:
	...
	extu.w r0,r0
	tst r0,r0
	bt loc_8c1b6468               ; loc_8c1b6438+0x30
	mov.l @(0x74,PC),r4
	mov 0x00,r5
	mov.w @(0x62,PC),r2
	mov.b @r4,r3
...
loc_8c1B64B6:
	...
	mov.l @(0xE4,PC),r7
	mov.l @(0xE8,PC),r6
	bt.s loc_8c1b6514             ; loc_8c1b64f2+0x22
	mov.b r12,@r2
	cmp/eq 0x01,r0
	bt loc_8c1b6514               ; loc_8c1b64f2+0x22
	cmp/eq 0x02,r0
	bt loc_8c1b6514               ; loc_8c1b64f2+0x22
	cmp/eq 0x03,r0
	bf loc_8c1b64e8
	bra loc_8c1b65f4            ; loc_8c1b65ec+0x8
	nop
...
loc_8c1B64F0:
	...
	bt loc_8c1b6514
	cmp/eq 0x1A,r0
	bt loc_8c1b65f4             ; loc_8c1b65ec+0x8
	cmp/eq 0x1B,r0
	bt loc_8c1b65f4             ; loc_8c1b65ec+0x8
	cmp/eq 0x1D,r0
	bt loc_8c1b655c
...
loc_8c1B655C:
	...
	mov.w r13,@r1
	mov 0x02,r0
	bra loc_8c1b6572              ; loc_8c1b6570+0x2
	mov.b r0,@r5
...
loc_8c1B67ea:
	...
	mov.b @r2,r1
	cmp/pz r1
	bt loc_8c1b684c               ; loc_8c1b6816+0x36
...
loc_8c1B6A4C:
	...
	extu.b r0,r0
	cmp/eq 0x16,r0
	bt loc_8c1b6afc               ; loc_8c1b6ae4+0x18
	cmp/eq 0x17,r0
	bt loc_8c1b6afc               ; loc_8c1b6ae4+0x18
	cmp/eq 0x18,r0
	bt loc_8c1b6afc               ; loc_8c1b6ae4+0x18
...
loc_8c1B6CBA:
	extu.w r14,r0
	cmp/eq 0x04,r0
	bf loc_8c1b6ce0               ; loc_8c1b6cca+0x16
	bsr loc_8c1b6ea4
	nop
	extu.w r0,r0
	tst r0,r0
	bt loc_8c1b6cd6               ; loc_8c1b6cca+0xc
	mov.l @(0x84,PC),r2
	jsr @r2
	mov 0x20,r4
	mov.l r0,@r11
...
loc_8c1B6CD6:
	...
	jsr @r2
	nop
	bra loc_8c1b6e04              ; loc_8c1b6d58+0xac
	nop
