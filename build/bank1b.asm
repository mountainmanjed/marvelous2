...
loc_8c1b0748:
	mov.b r12,@r14
	bra loc_8c1b07d6              ; loc_8c1b06b8+0x11e
	mov.b r12,@r13
...
loc_8c1B1E48:
	...
	extu.b r3,r3
	cmp/eq r3,r10
	bf loc_8c1b1f06               ; loc_8c1b1e80+0x86
...
loc_8c1B1E60:
	...
	exts.b r0,r0
	tst r0,r0
	bt loc_8c1b1f06               ; loc_8c1b1e80+0x86
	mov r13,r0
	nop
	mov.b @(0x4,r0),r0
	tst 0x80,r0
...
loc_8c1B1EA6:
	...
	mov.b @(0x4,r13),r0
	or 0x40,r0
	bra loc_8c1b1f06              ; loc_8c1b1e80+0x86
	mov.b r0,@(0x4,r13)
...
loc_8c1B317E:
	...
	jsr @r12
	mov r14,r4
	bra loc_8c1b31be              ; loc_8c1b3102+0xbc
	nop
